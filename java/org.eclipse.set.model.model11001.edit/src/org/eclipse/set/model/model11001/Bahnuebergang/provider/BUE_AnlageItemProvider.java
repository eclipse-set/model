...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.model.model11001.Bahnuebergang.BUE_Anlage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BUE_AnlageItemProvider extends Punkt_ObjektItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BahnuebergangPackage.eINSTANCE.getBUE_Anlage_IDAEABUEAnschaltung());
		...
		newChildDescriptors.add
			(createChildParameter
				(BahnuebergangPackage.eINSTANCE.getBUE_Anlage_IDAEABUEAnschaltung(),
				 VerweiseFactory.eINSTANCE.createID_Aussenelementansteuerung_ohne_Proxy_TypeClass()));
