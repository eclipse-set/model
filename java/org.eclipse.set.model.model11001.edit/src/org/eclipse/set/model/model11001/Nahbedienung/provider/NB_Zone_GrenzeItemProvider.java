...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.model.model11001.Nahbedienung.NB_Zone_Grenze} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NB_Zone_GrenzeItemProvider extends Basis_ObjektItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NahbedienungPackage.Literals.NB_ZONE_GRENZE__ID_MARKANTER_PUNKT);
			childrenFeatures.add(NahbedienungPackage.Literals.NB_ZONE_GRENZE__IDNB_ZONE);
			childrenFeatures.add(NahbedienungPackage.Literals.NB_ZONE_GRENZE__NB_GRENZE_ART);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NahbedienungPackage.Literals.NB_ZONE_GRENZE__ID_MARKANTER_PUNKT,
				 VerweiseFactory.eINSTANCE.createID_Markanter_Punkt_TypeClass()));

		newChildDescriptors.add
			(createChildParameter
				(NahbedienungPackage.Literals.NB_ZONE_GRENZE__IDNB_ZONE,
				 VerweiseFactory.eINSTANCE.createID_NB_Zone_TypeClass()));

		newChildDescriptors.add
			(createChildParameter
				(NahbedienungPackage.Literals.NB_ZONE_GRENZE__NB_GRENZE_ART,
