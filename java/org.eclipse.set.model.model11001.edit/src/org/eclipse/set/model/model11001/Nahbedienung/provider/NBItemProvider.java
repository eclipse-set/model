...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.model.model11001.Nahbedienung.NB} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NBItemProvider extends Basis_ObjektItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NahbedienungPackage.Literals.NB__BEZEICHNUNG);
			childrenFeatures.add(NahbedienungPackage.Literals.NB__NB_ART);
			childrenFeatures.add(NahbedienungPackage.Literals.NB__NB_FUNKTIONALITAET_NBR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NahbedienungPackage.Literals.NB__BEZEICHNUNG,
				 NahbedienungFactory.eINSTANCE.createNB_Bezeichnung_AttributeGroup()));

		newChildDescriptors.add
			(createChildParameter
				(NahbedienungPackage.Literals.NB__NB_ART,
				 NahbedienungFactory.eINSTANCE.createNB_Art_TypeClass()));

		newChildDescriptors.add
			(createChildParameter
				(NahbedienungPackage.Literals.NB__NB_FUNKTIONALITAET_NBR,
				 NahbedienungFactory.eINSTANCE.createNB_Funktionalitaet_NB_R_AttributeGroup()));
	}
