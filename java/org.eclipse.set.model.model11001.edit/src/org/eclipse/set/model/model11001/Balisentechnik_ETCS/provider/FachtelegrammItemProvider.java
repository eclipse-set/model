...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.model.model11001.Balisentechnik_ETCS.Fachtelegramm} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FachtelegrammItemProvider extends Basis_ObjektItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Balisentechnik_ETCSPackage.eINSTANCE.getFachtelegramm_IDDokuTelegrammkodierung());
		...
		newChildDescriptors.add
			(createChildParameter
				(Balisentechnik_ETCSPackage.eINSTANCE.getFachtelegramm_IDDokuTelegrammkodierung(),
				 VerweiseFactory.eINSTANCE.createID_AnhangBearbeitungsvermerk_TypeClass()));
