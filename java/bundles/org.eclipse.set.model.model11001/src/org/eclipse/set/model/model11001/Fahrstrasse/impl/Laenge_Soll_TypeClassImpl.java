...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Laenge Soll Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Fahrstrasse.impl.Laenge_Soll_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Laenge_Soll_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Laenge_Soll_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Laenge_Soll_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FahrstrassePackage.Literals.LAENGE_SOLL_TYPE_CLASS;
	}
	...
	public void setWert(BigDecimal newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FahrstrassePackage.LAENGE_SOLL_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FahrstrassePackage.LAENGE_SOLL_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
