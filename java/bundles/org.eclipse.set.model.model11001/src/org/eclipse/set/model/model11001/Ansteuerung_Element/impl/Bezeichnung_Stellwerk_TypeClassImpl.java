 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Ansteuerung_Element.impl.Bezeichnung_Stellwerk_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Bezeichnung_Stellwerk_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Bezeichnung_Stellwerk_TypeClass {
	...
	protected EClass eStaticClass() {
		return Ansteuerung_ElementPackage.Literals.BEZEICHNUNG_STELLWERK_TYPE_CLASS;
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ansteuerung_ElementPackage.BEZEICHNUNG_STELLWERK_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ansteuerung_ElementPackage.BEZEICHNUNG_STELLWERK_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
