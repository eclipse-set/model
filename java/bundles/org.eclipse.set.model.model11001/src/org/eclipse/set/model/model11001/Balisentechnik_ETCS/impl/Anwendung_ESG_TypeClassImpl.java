...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Anwendung ESG Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Balisentechnik_ETCS.impl.Anwendung_ESG_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Anwendung_ESG_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Anwendung_ESG_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Anwendung_ESG_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Balisentechnik_ETCSPackage.eINSTANCE.getAnwendung_ESG_TypeClass();
	}
	...
	public void setWert(Boolean newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Balisentechnik_ETCSPackage.ANWENDUNG_ESG_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Balisentechnik_ETCSPackage.ANWENDUNG_ESG_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
