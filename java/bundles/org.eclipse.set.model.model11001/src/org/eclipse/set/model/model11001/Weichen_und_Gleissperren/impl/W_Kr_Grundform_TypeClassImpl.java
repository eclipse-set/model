...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>WKr Grundform Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Weichen_und_Gleissperren.impl.W_Kr_Grundform_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class W_Kr_Grundform_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements W_Kr_Grundform_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected W_Kr_Grundform_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Weichen_und_GleissperrenPackage.Literals.WKR_GRUNDFORM_TYPE_CLASS;
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Weichen_und_GleissperrenPackage.WKR_GRUNDFORM_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Weichen_und_GleissperrenPackage.WKR_GRUNDFORM_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
