...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bezeichnung Fstr DWeg Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Fahrstrasse.impl.Bezeichnung_Fstr_DWeg_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Bezeichnung_Fstr_DWeg_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Bezeichnung_Fstr_DWeg_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Bezeichnung_Fstr_DWeg_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FahrstrassePackage.Literals.BEZEICHNUNG_FSTR_DWEG_TYPE_CLASS;
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FahrstrassePackage.BEZEICHNUNG_FSTR_DWEG_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FahrstrassePackage.BEZEICHNUNG_FSTR_DWEG_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Bezeichnung_Fstr_DWeg_TypeClassImpl
