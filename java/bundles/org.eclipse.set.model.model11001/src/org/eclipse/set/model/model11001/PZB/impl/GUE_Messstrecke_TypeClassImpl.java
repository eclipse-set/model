...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GUE Messstrecke Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.PZB.impl.GUE_Messstrecke_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GUE_Messstrecke_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements GUE_Messstrecke_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected GUE_Messstrecke_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PZBPackage.Literals.GUE_MESSSTRECKE_TYPE_CLASS;
	}
	...
	public void setWert(BigDecimal newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PZBPackage.GUE_MESSSTRECKE_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PZBPackage.GUE_MESSSTRECKE_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
