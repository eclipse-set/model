...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Anzahl Wiederhol ZL Anstoesse Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Zuglenkung.impl.Anzahl_Wiederhol_ZL_Anstoesse_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Anzahl_Wiederhol_ZL_Anstoesse_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Anzahl_Wiederhol_ZL_Anstoesse_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Anzahl_Wiederhol_ZL_Anstoesse_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ZuglenkungPackage.Literals.ANZAHL_WIEDERHOL_ZL_ANSTOESSE_TYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZuglenkungPackage.ANZAHL_WIEDERHOL_ZL_ANSTOESSE_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ZuglenkungPackage.ANZAHL_WIEDERHOL_ZL_ANSTOESSE_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Anzahl_Wiederhol_ZL_Anstoesse_TypeClassImpl
