...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>DP Typ ETCS Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Balisentechnik_ETCS.impl.DP_Typ_ETCS_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DP_Typ_ETCS_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements DP_Typ_ETCS_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected DP_Typ_ETCS_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Balisentechnik_ETCSPackage.eINSTANCE.getDP_Typ_ETCS_TypeClass();
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Balisentechnik_ETCSPackage.DP_TYP_ETCS_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Balisentechnik_ETCSPackage.DP_TYP_ETCS_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
