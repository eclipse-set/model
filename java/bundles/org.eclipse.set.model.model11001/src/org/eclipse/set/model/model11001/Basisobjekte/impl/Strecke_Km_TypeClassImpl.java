 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Basisobjekte.impl.Strecke_Km_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Strecke_Km_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Strecke_Km_TypeClass {
	...
	protected EClass eStaticClass() {
		return BasisobjektePackage.Literals.STRECKE_KM_TYPE_CLASS;
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisobjektePackage.STRECKE_KM_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BasisobjektePackage.STRECKE_KM_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
