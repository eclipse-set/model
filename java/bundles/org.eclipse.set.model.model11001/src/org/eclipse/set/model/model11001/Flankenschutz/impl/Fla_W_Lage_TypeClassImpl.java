...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Fla WLage Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Flankenschutz.impl.Fla_W_Lage_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Fla_W_Lage_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Fla_W_Lage_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Fla_W_Lage_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FlankenschutzPackage.Literals.FLA_WLAGE_TYPE_CLASS;
	}
	...
	public void setWert(ENUMLinksRechts newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlankenschutzPackage.FLA_WLAGE_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FlankenschutzPackage.FLA_WLAGE_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
