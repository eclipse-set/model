...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Verwendung Hilfe Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Balisentechnik_ETCS.impl.Verwendung_Hilfe_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Verwendung_Hilfe_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Verwendung_Hilfe_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Verwendung_Hilfe_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Balisentechnik_ETCSPackage.eINSTANCE.getVerwendung_Hilfe_TypeClass();
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Balisentechnik_ETCSPackage.VERWENDUNG_HILFE_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Balisentechnik_ETCSPackage.VERWENDUNG_HILFE_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Verwendung_Hilfe_TypeClassImpl
