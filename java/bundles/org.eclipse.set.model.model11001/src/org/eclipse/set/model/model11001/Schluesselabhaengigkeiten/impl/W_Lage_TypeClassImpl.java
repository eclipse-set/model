...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>WLage Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Schluesselabhaengigkeiten.impl.W_Lage_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class W_Lage_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements W_Lage_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected W_Lage_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SchluesselabhaengigkeitenPackage.Literals.WLAGE_TYPE_CLASS;
	}
	...
	public void setWert(ENUMLinksRechts newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchluesselabhaengigkeitenPackage.WLAGE_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SchluesselabhaengigkeitenPackage.WLAGE_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
