...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bezeichnung ATO TP Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.ATO.impl.Bezeichnung_ATO_TP_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Bezeichnung_ATO_TP_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Bezeichnung_ATO_TP_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Bezeichnung_ATO_TP_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ATOPackage.Literals.BEZEICHNUNG_ATO_TP_TYPE_CLASS;
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ATOPackage.BEZEICHNUNG_ATO_TP_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ATOPackage.BEZEICHNUNG_ATO_TP_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Bezeichnung_ATO_TP_TypeClassImpl
