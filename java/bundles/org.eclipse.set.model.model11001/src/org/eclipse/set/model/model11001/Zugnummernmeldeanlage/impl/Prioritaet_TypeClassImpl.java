...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Prioritaet Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Zugnummernmeldeanlage.impl.Prioritaet_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Prioritaet_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Prioritaet_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Prioritaet_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ZugnummernmeldeanlagePackage.Literals.PRIORITAET_TYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZugnummernmeldeanlagePackage.PRIORITAET_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ZugnummernmeldeanlagePackage.PRIORITAET_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
