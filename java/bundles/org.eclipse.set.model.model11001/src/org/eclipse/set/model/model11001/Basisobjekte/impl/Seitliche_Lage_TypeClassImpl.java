...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Seitliche Lage Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Basisobjekte.impl.Seitliche_Lage_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Seitliche_Lage_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Seitliche_Lage_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Seitliche_Lage_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return BasisobjektePackage.Literals.SEITLICHE_LAGE_TYPE_CLASS;
	}
	...
	public void setWert(ENUMLinksRechts newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisobjektePackage.SEITLICHE_LAGE_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BasisobjektePackage.SEITLICHE_LAGE_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
