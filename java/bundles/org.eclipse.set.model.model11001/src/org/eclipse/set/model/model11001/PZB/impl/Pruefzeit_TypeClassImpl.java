...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pruefzeit Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.PZB.impl.Pruefzeit_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pruefzeit_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Pruefzeit_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Pruefzeit_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PZBPackage.Literals.PRUEFZEIT_TYPE_CLASS;
	}
	...
	public void setWert(BigDecimal newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PZBPackage.PRUEFZEIT_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PZBPackage.PRUEFZEIT_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
