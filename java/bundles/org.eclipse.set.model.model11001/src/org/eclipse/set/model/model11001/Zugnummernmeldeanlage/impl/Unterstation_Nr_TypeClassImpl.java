...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Unterstation Nr Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Zugnummernmeldeanlage.impl.Unterstation_Nr_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Unterstation_Nr_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Unterstation_Nr_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Unterstation_Nr_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ZugnummernmeldeanlagePackage.Literals.UNTERSTATION_NR_TYPE_CLASS;
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZugnummernmeldeanlagePackage.UNTERSTATION_NR_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ZugnummernmeldeanlagePackage.UNTERSTATION_NR_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
