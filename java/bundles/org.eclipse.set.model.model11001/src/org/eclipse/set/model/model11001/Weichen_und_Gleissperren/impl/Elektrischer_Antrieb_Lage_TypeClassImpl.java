...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Elektrischer Antrieb Lage Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Weichen_und_Gleissperren.impl.Elektrischer_Antrieb_Lage_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Elektrischer_Antrieb_Lage_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Elektrischer_Antrieb_Lage_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Elektrischer_Antrieb_Lage_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Weichen_und_GleissperrenPackage.Literals.ELEKTRISCHER_ANTRIEB_LAGE_TYPE_CLASS;
	}
	...
	public void setWert(ENUMElektrischerAntriebLage newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Weichen_und_GleissperrenPackage.ELEKTRISCHER_ANTRIEB_LAGE_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Weichen_und_GleissperrenPackage.ELEKTRISCHER_ANTRIEB_LAGE_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Elektrischer_Antrieb_Lage_TypeClassImpl
