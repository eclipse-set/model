...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Gleis Am Bue Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Bahnuebergang.impl.Gleis_Am_Bue_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Gleis_Am_Bue_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Gleis_Am_Bue_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Gleis_Am_Bue_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return BahnuebergangPackage.eINSTANCE.getGleis_Am_Bue_TypeClass();
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BahnuebergangPackage.GLEIS_AM_BUE_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BahnuebergangPackage.GLEIS_AM_BUE_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
