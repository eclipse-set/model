...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstand Datenpunkt EP TPI Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Balisentechnik_ETCS.impl.Abstand_Datenpunkt_EP_TPI_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Abstand_Datenpunkt_EP_TPI_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Abstand_Datenpunkt_EP_TPI_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Abstand_Datenpunkt_EP_TPI_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Balisentechnik_ETCSPackage.eINSTANCE.getAbstand_Datenpunkt_EP_TPI_TypeClass();
	}
	...
	public void setWert(BigDecimal newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Balisentechnik_ETCSPackage.ABSTAND_DATENPUNKT_EP_TPI_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Balisentechnik_ETCSPackage.ABSTAND_DATENPUNKT_EP_TPI_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Abstand_Datenpunkt_EP_TPI_TypeClassImpl
