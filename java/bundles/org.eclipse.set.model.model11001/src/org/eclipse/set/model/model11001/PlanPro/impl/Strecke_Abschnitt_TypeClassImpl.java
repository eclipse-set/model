...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Strecke Abschnitt Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.PlanPro.impl.Strecke_Abschnitt_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Strecke_Abschnitt_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Strecke_Abschnitt_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Strecke_Abschnitt_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PlanProPackage.eINSTANCE.getStrecke_Abschnitt_TypeClass();
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlanProPackage.STRECKE_ABSCHNITT_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PlanProPackage.STRECKE_ABSCHNITT_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Strecke_Abschnitt_TypeClassImpl
