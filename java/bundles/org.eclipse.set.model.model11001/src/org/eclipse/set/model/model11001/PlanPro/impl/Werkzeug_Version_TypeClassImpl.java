...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Werkzeug Version Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.PlanPro.impl.Werkzeug_Version_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Werkzeug_Version_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Werkzeug_Version_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Werkzeug_Version_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PlanProPackage.eINSTANCE.getWerkzeug_Version_TypeClass();
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlanProPackage.WERKZEUG_VERSION_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PlanProPackage.WERKZEUG_VERSION_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Werkzeug_Version_TypeClassImpl
