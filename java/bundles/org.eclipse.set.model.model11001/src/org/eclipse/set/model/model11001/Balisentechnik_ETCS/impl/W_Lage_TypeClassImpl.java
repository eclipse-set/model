 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Balisentechnik_ETCS.impl.W_Lage_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class W_Lage_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements W_Lage_TypeClass {
	...
	protected EClass eStaticClass() {
		return Balisentechnik_ETCSPackage.eINSTANCE.getW_Lage_TypeClass();
	}
	...
	public void setWert(ENUMLinksRechts newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Balisentechnik_ETCSPackage.WLAGE_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Balisentechnik_ETCSPackage.WLAGE_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
