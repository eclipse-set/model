...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GEO Radius AType Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Geodaten.impl.GEO_Radius_A_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GEO_Radius_A_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements GEO_Radius_A_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected GEO_Radius_A_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GeodatenPackage.Literals.GEO_RADIUS_ATYPE_CLASS;
	}
	...
	public void setWert(BigDecimal newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeodatenPackage.GEO_RADIUS_ATYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GeodatenPackage.GEO_RADIUS_ATYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
