...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Organisationseinheit Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.PlanPro.impl.Organisationseinheit_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Organisationseinheit_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Organisationseinheit_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Organisationseinheit_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PlanProPackage.eINSTANCE.getOrganisationseinheit_TypeClass();
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlanProPackage.ORGANISATIONSEINHEIT_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PlanProPackage.ORGANISATIONSEINHEIT_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Organisationseinheit_TypeClassImpl
