...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.model.model1902.PZB.PZB_Element_Zuordnung_INA_AttributeGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PZB_Element_Zuordnung_INA_AttributeGroupItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PZBPackage.Literals.PZB_ELEMENT_ZUORDNUNG_INA_ATTRIBUTE_GROUP__ID_ANHANG_INA);
			childrenFeatures.add(PZBPackage.Literals.PZB_ELEMENT_ZUORDNUNG_INA_ATTRIBUTE_GROUP__ID_BAHNSTEIG_KANTE);
			childrenFeatures.add(PZBPackage.Literals.PZB_ELEMENT_ZUORDNUNG_INA_ATTRIBUTE_GROUP__ID_MARKANTER_PUNKT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PZB_Element_Zuordnung_INA_AttributeGroup.class)) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PZBPackage.Literals.PZB_ELEMENT_ZUORDNUNG_INA_ATTRIBUTE_GROUP__ID_BAHNSTEIG_KANTE,
				 VerweiseFactory.eINSTANCE.createID_Bahnsteig_Kante_TypeClass()));
