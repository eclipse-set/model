 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model1902.Nahbedienbereich.impl.NB_Zone_ElementImpl#getIDNBElement <em>IDNB Element</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Nahbedienbereich.impl.NB_Zone_ElementImpl#getIDNBZone <em>IDNB Zone</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Nahbedienbereich.impl.NB_Zone_ElementImpl#getNBZoneElementAllg <em>NB Zone Element Allg</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NB_Zone_ElementImpl extends Basis_ObjektImpl implements NB_Zone_Element {
	...
	protected EClass eStaticClass() {
		return NahbedienbereichPackage.Literals.NB_ZONE_ELEMENT;
	}
	...
	public NotificationChain basicSetIDNBElement(ID_NB_Element_TypeClass newIDNBElement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_ZONE_ELEMENT__IDNB_ELEMENT, oldIDNBElement, newIDNBElement);
	...
	public void setIDNBElement(ID_NB_Element_TypeClass newIDNBElement) {
		if (newIDNBElement != iDNBElement) {
			...
			if (iDNBElement != null)
				msgs = ((InternalEObject)iDNBElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - NahbedienbereichPackage.NB_ZONE_ELEMENT__IDNB_ELEMENT, null, msgs);
			if (newIDNBElement != null)
				msgs = ((InternalEObject)newIDNBElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - NahbedienbereichPackage.NB_ZONE_ELEMENT__IDNB_ELEMENT, null, msgs);
			msgs = basicSetIDNBElement(newIDNBElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_ZONE_ELEMENT__IDNB_ELEMENT, newIDNBElement, newIDNBElement));
	}
	...
	public NotificationChain basicSetIDNBZone(ID_NB_Zone_TypeClass newIDNBZone, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_ZONE_ELEMENT__IDNB_ZONE, oldIDNBZone, newIDNBZone);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIDNBZone(ID_NB_Zone_TypeClass newIDNBZone) {
		if (newIDNBZone != iDNBZone) {
			NotificationChain msgs = null;
			if (iDNBZone != null)
				msgs = ((InternalEObject)iDNBZone).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - NahbedienbereichPackage.NB_ZONE_ELEMENT__IDNB_ZONE, null, msgs);
			if (newIDNBZone != null)
				msgs = ((InternalEObject)newIDNBZone).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - NahbedienbereichPackage.NB_ZONE_ELEMENT__IDNB_ZONE, null, msgs);
			msgs = basicSetIDNBZone(newIDNBZone, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_ZONE_ELEMENT__IDNB_ZONE, newIDNBZone, newIDNBZone));
	}
	...
	public NotificationChain basicSetNBZoneElementAllg(NB_Zone_Element_Allg_AttributeGroup newNBZoneElementAllg, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_ZONE_ELEMENT__NB_ZONE_ELEMENT_ALLG, oldNBZoneElementAllg, newNBZoneElementAllg);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNBZoneElementAllg(NB_Zone_Element_Allg_AttributeGroup newNBZoneElementAllg) {
		if (newNBZoneElementAllg != nBZoneElementAllg) {
			...
			if (nBZoneElementAllg != null)
				msgs = ((InternalEObject)nBZoneElementAllg).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - NahbedienbereichPackage.NB_ZONE_ELEMENT__NB_ZONE_ELEMENT_ALLG, null, msgs);
			if (newNBZoneElementAllg != null)
				msgs = ((InternalEObject)newNBZoneElementAllg).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - NahbedienbereichPackage.NB_ZONE_ELEMENT__NB_ZONE_ELEMENT_ALLG, null, msgs);
			msgs = basicSetNBZoneElementAllg(newNBZoneElementAllg, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_ZONE_ELEMENT__NB_ZONE_ELEMENT_ALLG, newNBZoneElementAllg, newNBZoneElementAllg));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NahbedienbereichPackage.NB_ZONE_ELEMENT__IDNB_ELEMENT:
				return basicSetIDNBElement(null, msgs);
			case NahbedienbereichPackage.NB_ZONE_ELEMENT__IDNB_ZONE:
				return basicSetIDNBZone(null, msgs);
			case NahbedienbereichPackage.NB_ZONE_ELEMENT__NB_ZONE_ELEMENT_ALLG:
