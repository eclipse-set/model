 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model1902.Ansteuerung_Element.impl.AEA_Energieversorgung_AttributeGroupImpl#getEnergieversorgungArtErsatz <em>Energieversorgung Art Ersatz</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Ansteuerung_Element.impl.AEA_Energieversorgung_AttributeGroupImpl#getIDEnergieSekundaer <em>ID Energie Sekundaer</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Ansteuerung_Element.impl.AEA_Energieversorgung_AttributeGroupImpl#getEnergieversorgungArt <em>Energieversorgung Art</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Ansteuerung_Element.impl.AEA_Energieversorgung_AttributeGroupImpl#getIDEnergiePrimaer <em>ID Energie Primaer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AEA_Energieversorgung_AttributeGroupImpl extends MinimalEObjectImpl.Container implements AEA_Energieversorgung_AttributeGroup {
	/**
	 ...
	 * @ordered
	 */
	protected ID_Aussenelementansteuerung_TypeClass iDEnergieSekundaer;
	 ...
	 * @ordered
	 */
	protected ID_Energie_Primaer_TypeClass iDEnergiePrimaer;
	 ...
	 */
	@Override
	public ID_Aussenelementansteuerung_TypeClass getIDEnergieSekundaer() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIDEnergieSekundaer(ID_Aussenelementansteuerung_TypeClass newIDEnergieSekundaer, NotificationChain msgs) {
		ID_Aussenelementansteuerung_TypeClass oldIDEnergieSekundaer = iDEnergieSekundaer;
	 ...
	 */
	@Override
	public void setIDEnergieSekundaer(ID_Aussenelementansteuerung_TypeClass newIDEnergieSekundaer) {
	 ...
	 */
	@Override
	public ID_Energie_Primaer_TypeClass getIDEnergiePrimaer() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIDEnergiePrimaer(ID_Energie_Primaer_TypeClass newIDEnergiePrimaer, NotificationChain msgs) {
		ID_Energie_Primaer_TypeClass oldIDEnergiePrimaer = iDEnergiePrimaer;
	 ...
	 */
	@Override
	public void setIDEnergiePrimaer(ID_Energie_Primaer_TypeClass newIDEnergiePrimaer) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Ansteuerung_ElementPackage.AEA_ENERGIEVERSORGUNG_ATTRIBUTE_GROUP__ENERGIEVERSORGUNG_ART_ERSATZ:
				...
				return;
			case Ansteuerung_ElementPackage.AEA_ENERGIEVERSORGUNG_ATTRIBUTE_GROUP__ID_ENERGIE_SEKUNDAER:
				setIDEnergieSekundaer((ID_Aussenelementansteuerung_TypeClass)newValue);
				return;
			case Ansteuerung_ElementPackage.AEA_ENERGIEVERSORGUNG_ATTRIBUTE_GROUP__ENERGIEVERSORGUNG_ART:
				setEnergieversorgungArt((Energieversorgung_Art_TypeClass)newValue);
				return;
			case Ansteuerung_ElementPackage.AEA_ENERGIEVERSORGUNG_ATTRIBUTE_GROUP__ID_ENERGIE_PRIMAER:
				setIDEnergiePrimaer((ID_Energie_Primaer_TypeClass)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case Ansteuerung_ElementPackage.AEA_ENERGIEVERSORGUNG_ATTRIBUTE_GROUP__ENERGIEVERSORGUNG_ART_ERSATZ:
				...
				return;
			case Ansteuerung_ElementPackage.AEA_ENERGIEVERSORGUNG_ATTRIBUTE_GROUP__ID_ENERGIE_SEKUNDAER:
				setIDEnergieSekundaer((ID_Aussenelementansteuerung_TypeClass)null);
				return;
			case Ansteuerung_ElementPackage.AEA_ENERGIEVERSORGUNG_ATTRIBUTE_GROUP__ENERGIEVERSORGUNG_ART:
				setEnergieversorgungArt((Energieversorgung_Art_TypeClass)null);
				return;
			case Ansteuerung_ElementPackage.AEA_ENERGIEVERSORGUNG_ATTRIBUTE_GROUP__ID_ENERGIE_PRIMAER:
				setIDEnergiePrimaer((ID_Energie_Primaer_TypeClass)null);
				return;
		}
