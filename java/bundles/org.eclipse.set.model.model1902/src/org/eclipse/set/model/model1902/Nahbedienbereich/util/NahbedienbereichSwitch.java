...
import org.eclipse.set.model.model1902.Nahbedienbereich.*;
 ...
 * @generated
 */
public class NahbedienbereichSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case NahbedienbereichPackage.NB_ALLG_ATTRIBUTE_GROUP: {
				NB_Allg_AttributeGroup nB_Allg_AttributeGroup = (NB_Allg_AttributeGroup)theEObject;
				T result = caseNB_Allg_AttributeGroup(nB_Allg_AttributeGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case NahbedienbereichPackage.NB_BEZEICHNUNG_TYPE_CLASS: {
				NB_Bezeichnung_TypeClass nB_Bezeichnung_TypeClass = (NB_Bezeichnung_TypeClass)theEObject;
				T result = caseNB_Bezeichnung_TypeClass(nB_Bezeichnung_TypeClass);
				if (result == null) result = caseBasisAttribut_AttributeGroup(nB_Bezeichnung_TypeClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case NahbedienbereichPackage.NB_ZONE_BEZEICHNUNG_TYPE_CLASS: {
				NB_Zone_Bezeichnung_TypeClass nB_Zone_Bezeichnung_TypeClass = (NB_Zone_Bezeichnung_TypeClass)theEObject;
				T result = caseNB_Zone_Bezeichnung_TypeClass(nB_Zone_Bezeichnung_TypeClass);
				if (result == null) result = caseBasisAttribut_AttributeGroup(nB_Zone_Bezeichnung_TypeClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>NB Allg Attribute Group</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>NB Allg Attribute Group</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNB_Allg_AttributeGroup(NB_Allg_AttributeGroup object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>NB Bezeichnung Type Class</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>NB Bezeichnung Type Class</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNB_Bezeichnung_TypeClass(NB_Bezeichnung_TypeClass object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>NB Zone Bezeichnung Type Class</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>NB Zone Bezeichnung Type Class</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNB_Zone_Bezeichnung_TypeClass(NB_Zone_Bezeichnung_TypeClass object) {
		return null;
	}
