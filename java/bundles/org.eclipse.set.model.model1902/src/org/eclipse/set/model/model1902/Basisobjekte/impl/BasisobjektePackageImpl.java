...
import org.eclipse.set.model.model1902.Basisobjekte.util.BasisobjekteValidator;
...
public class BasisobjektePackageImpl extends EPackageImpl implements BasisobjektePackage {
	 ...
	 * @see org.eclipse.set.model.model1902.Basisobjekte.BasisobjektePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getBasis_Objekt_IDBearbeitungsvermerk(), theVerweisePackage.getID_Bearbeitungsvermerk_TypeClass(), null, "iDBearbeitungsvermerk", null, 0, -1, Basis_Objekt.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (identitaet_TypeEDataType,
		   ...
		   new String[] {
			   "name", "TIdentitaet",
			   "baseType", "http://www.plan-pro.org/modell/BasisTypen/1.9.0.2#TGUID"
		   });
		addAnnotation
		...
		addAnnotation
		  (strecke_Km_TypeEDataType,
		   ...
		   new String[] {
			   "name", "TStrecke_Km",
			   "baseType", "http://www.plan-pro.org/modell/BasisTypen/1.9.0.2#TKilometrierung"
		   });
		addAnnotation
