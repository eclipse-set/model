 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model1902.Nahbedienbereich.impl.NB_Zone_Allg_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NB_Zone_Allg_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements NB_Zone_Allg_TypeClass {
	...
	protected EClass eStaticClass() {
		return NahbedienbereichPackage.Literals.NB_ZONE_ALLG_TYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_ZONE_ALLG_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, NahbedienbereichPackage.NB_ZONE_ALLG_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
