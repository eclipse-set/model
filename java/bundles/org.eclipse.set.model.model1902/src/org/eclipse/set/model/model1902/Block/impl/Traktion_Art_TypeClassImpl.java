...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Traktion Art Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model1902.Block.impl.Traktion_Art_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Traktion_Art_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Traktion_Art_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Traktion_Art_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return BlockPackage.Literals.TRAKTION_ART_TYPE_CLASS;
	}
	...
	public void setWert(List<ENUMFahrstrom> newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlockPackage.TRAKTION_ART_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BlockPackage.TRAKTION_ART_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
