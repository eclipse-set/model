 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model1902.Ortung.impl.FMA_Komponente_Achszaehlpunkt_AttributeGroupImpl#getFMAKomponenteSchienenprofil <em>FMA Komponente Schienenprofil</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Ortung.impl.FMA_Komponente_Achszaehlpunkt_AttributeGroupImpl#getFMAKomponenteStromversorgung <em>FMA Komponente Stromversorgung</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Ortung.impl.FMA_Komponente_Achszaehlpunkt_AttributeGroupImpl#getFMAKomponenteTyp <em>FMA Komponente Typ</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Ortung.impl.FMA_Komponente_Achszaehlpunkt_AttributeGroupImpl#getIDEnergie <em>ID Energie</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Ortung.impl.FMA_Komponente_Achszaehlpunkt_AttributeGroupImpl#getIDInformation <em>ID Information</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FMA_Komponente_Achszaehlpunkt_AttributeGroupImpl extends MinimalEObjectImpl.Container implements FMA_Komponente_Achszaehlpunkt_AttributeGroup {
	...
	public NotificationChain basicSetIDInformation(ID_Aussenelementansteuerung_TypeClass newIDInformation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrtungPackage.FMA_KOMPONENTE_ACHSZAEHLPUNKT_ATTRIBUTE_GROUP__ID_INFORMATION, oldIDInformation, newIDInformation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIDInformation(ID_Aussenelementansteuerung_TypeClass newIDInformation) {
		if (newIDInformation != iDInformation) {
			...
			if (iDInformation != null)
				msgs = ((InternalEObject)iDInformation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrtungPackage.FMA_KOMPONENTE_ACHSZAEHLPUNKT_ATTRIBUTE_GROUP__ID_INFORMATION, null, msgs);
			if (newIDInformation != null)
				msgs = ((InternalEObject)newIDInformation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrtungPackage.FMA_KOMPONENTE_ACHSZAEHLPUNKT_ATTRIBUTE_GROUP__ID_INFORMATION, null, msgs);
			msgs = basicSetIDInformation(newIDInformation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrtungPackage.FMA_KOMPONENTE_ACHSZAEHLPUNKT_ATTRIBUTE_GROUP__ID_INFORMATION, newIDInformation, newIDInformation));
	}
