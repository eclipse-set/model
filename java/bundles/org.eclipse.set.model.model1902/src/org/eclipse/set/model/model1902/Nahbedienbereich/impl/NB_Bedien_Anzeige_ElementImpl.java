...
import org.eclipse.set.model.model1902.Verweise.ID_NB_Zone_TypeClass;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model1902.Nahbedienbereich.impl.NB_Bedien_Anzeige_ElementImpl#getIDBedienAnzeigeElement <em>ID Bedien Anzeige Element</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Nahbedienbereich.impl.NB_Bedien_Anzeige_ElementImpl#getIDNBZone <em>IDNB Zone</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Nahbedienbereich.impl.NB_Bedien_Anzeige_ElementImpl#getNBBedienAnzeigeFunktionen <em>NB Bedien Anzeige Funktionen</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NB_Bedien_Anzeige_ElementImpl extends Basis_ObjektImpl implements NB_Bedien_Anzeige_Element {
	...
	protected EClass eStaticClass() {
		return NahbedienbereichPackage.Literals.NB_BEDIEN_ANZEIGE_ELEMENT;
	}
	...
	public NotificationChain basicSetIDBedienAnzeigeElement(ID_Bedien_Anzeige_Element_TypeClass newIDBedienAnzeigeElement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_BEDIEN_ANZEIGE_ELEMENT__ID_BEDIEN_ANZEIGE_ELEMENT, oldIDBedienAnzeigeElement, newIDBedienAnzeigeElement);
	...
	public void setIDBedienAnzeigeElement(ID_Bedien_Anzeige_Element_TypeClass newIDBedienAnzeigeElement) {
		if (newIDBedienAnzeigeElement != iDBedienAnzeigeElement) {
			...
			if (iDBedienAnzeigeElement != null)
				msgs = ((InternalEObject)iDBedienAnzeigeElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - NahbedienbereichPackage.NB_BEDIEN_ANZEIGE_ELEMENT__ID_BEDIEN_ANZEIGE_ELEMENT, null, msgs);
			if (newIDBedienAnzeigeElement != null)
				msgs = ((InternalEObject)newIDBedienAnzeigeElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - NahbedienbereichPackage.NB_BEDIEN_ANZEIGE_ELEMENT__ID_BEDIEN_ANZEIGE_ELEMENT, null, msgs);
			msgs = basicSetIDBedienAnzeigeElement(newIDBedienAnzeigeElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_BEDIEN_ANZEIGE_ELEMENT__ID_BEDIEN_ANZEIGE_ELEMENT, newIDBedienAnzeigeElement, newIDBedienAnzeigeElement));
	}
	...
	public NotificationChain basicSetIDNBZone(ID_NB_Zone_TypeClass newIDNBZone, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_BEDIEN_ANZEIGE_ELEMENT__IDNB_ZONE, oldIDNBZone, newIDNBZone);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIDNBZone(ID_NB_Zone_TypeClass newIDNBZone) {
		if (newIDNBZone != iDNBZone) {
			NotificationChain msgs = null;
			if (iDNBZone != null)
				msgs = ((InternalEObject)iDNBZone).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - NahbedienbereichPackage.NB_BEDIEN_ANZEIGE_ELEMENT__IDNB_ZONE, null, msgs);
			if (newIDNBZone != null)
				msgs = ((InternalEObject)newIDNBZone).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - NahbedienbereichPackage.NB_BEDIEN_ANZEIGE_ELEMENT__IDNB_ZONE, null, msgs);
			msgs = basicSetIDNBZone(newIDNBZone, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_BEDIEN_ANZEIGE_ELEMENT__IDNB_ZONE, newIDNBZone, newIDNBZone));
	}
	...
	public NotificationChain basicSetNBBedienAnzeigeFunktionen(NB_Bedien_Anzeige_Funktionen_AttributeGroup newNBBedienAnzeigeFunktionen, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_BEDIEN_ANZEIGE_ELEMENT__NB_BEDIEN_ANZEIGE_FUNKTIONEN, oldNBBedienAnzeigeFunktionen, newNBBedienAnzeigeFunktionen);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNBBedienAnzeigeFunktionen(NB_Bedien_Anzeige_Funktionen_AttributeGroup newNBBedienAnzeigeFunktionen) {
		if (newNBBedienAnzeigeFunktionen != nBBedienAnzeigeFunktionen) {
			...
			if (nBBedienAnzeigeFunktionen != null)
				msgs = ((InternalEObject)nBBedienAnzeigeFunktionen).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - NahbedienbereichPackage.NB_BEDIEN_ANZEIGE_ELEMENT__NB_BEDIEN_ANZEIGE_FUNKTIONEN, null, msgs);
			if (newNBBedienAnzeigeFunktionen != null)
				msgs = ((InternalEObject)newNBBedienAnzeigeFunktionen).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - NahbedienbereichPackage.NB_BEDIEN_ANZEIGE_ELEMENT__NB_BEDIEN_ANZEIGE_FUNKTIONEN, null, msgs);
			msgs = basicSetNBBedienAnzeigeFunktionen(newNBBedienAnzeigeFunktionen, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_BEDIEN_ANZEIGE_ELEMENT__NB_BEDIEN_ANZEIGE_FUNKTIONEN, newNBBedienAnzeigeFunktionen, newNBBedienAnzeigeFunktionen));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NahbedienbereichPackage.NB_BEDIEN_ANZEIGE_ELEMENT__ID_BEDIEN_ANZEIGE_ELEMENT:
				return basicSetIDBedienAnzeigeElement(null, msgs);
			case NahbedienbereichPackage.NB_BEDIEN_ANZEIGE_ELEMENT__IDNB_ZONE:
