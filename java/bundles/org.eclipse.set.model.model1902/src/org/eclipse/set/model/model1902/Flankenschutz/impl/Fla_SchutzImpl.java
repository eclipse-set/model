 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model1902.Flankenschutz.impl.Fla_SchutzImpl#getFlaSchutzAnforderer <em>Fla Schutz Anforderer</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Flankenschutz.impl.Fla_SchutzImpl#getIDFlaWeitergabeEKW <em>ID Fla Weitergabe EKW</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Flankenschutz.impl.Fla_SchutzImpl#getFlaSchutzSignal <em>Fla Schutz Signal</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Flankenschutz.impl.Fla_SchutzImpl#getFlaSchutzWGsp <em>Fla Schutz WGsp</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Flankenschutz.impl.Fla_SchutzImpl#getFlaSchutzWeitergabe <em>Fla Schutz Weitergabe</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Flankenschutz.impl.Fla_SchutzImpl#getFlaVerzicht <em>Fla Verzicht</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Fla_SchutzImpl extends Basis_ObjektImpl implements Fla_Schutz {
	...
	/**
	 * The cached value of the '{@link #getIDFlaWeitergabeEKW() <em>ID Fla Weitergabe EKW</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected ID_Fla_Schutz_TypeClass iDFlaWeitergabeEKW;
	 ...
	 */
	@Override
	public ID_Fla_Schutz_TypeClass getIDFlaWeitergabeEKW() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIDFlaWeitergabeEKW(ID_Fla_Schutz_TypeClass newIDFlaWeitergabeEKW, NotificationChain msgs) {
		ID_Fla_Schutz_TypeClass oldIDFlaWeitergabeEKW = iDFlaWeitergabeEKW;
		iDFlaWeitergabeEKW = newIDFlaWeitergabeEKW;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FlankenschutzPackage.FLA_SCHUTZ__ID_FLA_WEITERGABE_EKW, oldIDFlaWeitergabeEKW, newIDFlaWeitergabeEKW);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	 ...
	 */
	@Override
	public void setIDFlaWeitergabeEKW(ID_Fla_Schutz_TypeClass newIDFlaWeitergabeEKW) {
		if (newIDFlaWeitergabeEKW != iDFlaWeitergabeEKW) {
			NotificationChain msgs = null;
			if (iDFlaWeitergabeEKW != null)
				msgs = ((InternalEObject)iDFlaWeitergabeEKW).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FlankenschutzPackage.FLA_SCHUTZ__ID_FLA_WEITERGABE_EKW, null, msgs);
			if (newIDFlaWeitergabeEKW != null)
				msgs = ((InternalEObject)newIDFlaWeitergabeEKW).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FlankenschutzPackage.FLA_SCHUTZ__ID_FLA_WEITERGABE_EKW, null, msgs);
			msgs = basicSetIDFlaWeitergabeEKW(newIDFlaWeitergabeEKW, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlankenschutzPackage.FLA_SCHUTZ__ID_FLA_WEITERGABE_EKW, newIDFlaWeitergabeEKW, newIDFlaWeitergabeEKW));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FlankenschutzPackage.FLA_SCHUTZ__ID_FLA_WEITERGABE_EKW:
				return basicSetIDFlaWeitergabeEKW(null, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FlankenschutzPackage.FLA_SCHUTZ__FLA_SCHUTZ_ANFORDERER:
				...
				return;
			case FlankenschutzPackage.FLA_SCHUTZ__ID_FLA_WEITERGABE_EKW:
				setIDFlaWeitergabeEKW((ID_Fla_Schutz_TypeClass)newValue);
				return;
			case FlankenschutzPackage.FLA_SCHUTZ__FLA_SCHUTZ_SIGNAL:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FlankenschutzPackage.FLA_SCHUTZ__FLA_SCHUTZ_ANFORDERER:
				...
				return;
			case FlankenschutzPackage.FLA_SCHUTZ__ID_FLA_WEITERGABE_EKW:
				setIDFlaWeitergabeEKW((ID_Fla_Schutz_TypeClass)null);
				return;
			case FlankenschutzPackage.FLA_SCHUTZ__FLA_SCHUTZ_SIGNAL:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case FlankenschutzPackage.FLA_SCHUTZ__ID_FLA_WEITERGABE_EKW:
				return iDFlaWeitergabeEKW != null;
			case FlankenschutzPackage.FLA_SCHUTZ__FLA_SCHUTZ_SIGNAL:
