...
public class GeodatenPackageImpl extends EPackageImpl implements GeodatenPackage {
	 ...
	 * @see org.eclipse.set.model.model1902.Geodaten.GeodatenPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (tB_Beschreibung_TypeEDataType,
		   ...
		   new String[] {
			   ...
			   "baseType", "http://www.plan-pro.org/modell/BasisTypen/1.9.0.2#TFreiText"
		   });
		addAnnotation
		...
		addAnnotation
		  (wirkrichtung_TypeEDataType,
		   ...
		   new String[] {
			   "name", "TWirkrichtung",
			   "baseType", "http://www.plan-pro.org/modell/BasisTypen/1.9.0.2#TWirkrichtung"
		   });
		addAnnotation
