 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model1902.Nahbedienbereich.impl.NB_Zone_GrenzeImpl#getIDMarkanterPunkt <em>ID Markanter Punkt</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Nahbedienbereich.impl.NB_Zone_GrenzeImpl#getIDNBZone <em>IDNB Zone</em>}</li>
 *   <li>{@link org.eclipse.set.model.model1902.Nahbedienbereich.impl.NB_Zone_GrenzeImpl#getNBGrenzeArt <em>NB Grenze Art</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NB_Zone_GrenzeImpl extends Basis_ObjektImpl implements NB_Zone_Grenze {
	...
	public NotificationChain basicSetIDMarkanterPunkt(ID_Markanter_Punkt_TypeClass newIDMarkanterPunkt, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_ZONE_GRENZE__ID_MARKANTER_PUNKT, oldIDMarkanterPunkt, newIDMarkanterPunkt);
	...
	public void setIDMarkanterPunkt(ID_Markanter_Punkt_TypeClass newIDMarkanterPunkt) {
		if (newIDMarkanterPunkt != iDMarkanterPunkt) {
			...
			if (iDMarkanterPunkt != null)
				msgs = ((InternalEObject)iDMarkanterPunkt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - NahbedienbereichPackage.NB_ZONE_GRENZE__ID_MARKANTER_PUNKT, null, msgs);
			if (newIDMarkanterPunkt != null)
				msgs = ((InternalEObject)newIDMarkanterPunkt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - NahbedienbereichPackage.NB_ZONE_GRENZE__ID_MARKANTER_PUNKT, null, msgs);
			msgs = basicSetIDMarkanterPunkt(newIDMarkanterPunkt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_ZONE_GRENZE__ID_MARKANTER_PUNKT, newIDMarkanterPunkt, newIDMarkanterPunkt));
	}
	...
	public NotificationChain basicSetIDNBZone(ID_NB_Zone_TypeClass newIDNBZone, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_ZONE_GRENZE__IDNB_ZONE, oldIDNBZone, newIDNBZone);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIDNBZone(ID_NB_Zone_TypeClass newIDNBZone) {
		if (newIDNBZone != iDNBZone) {
			NotificationChain msgs = null;
			if (iDNBZone != null)
				msgs = ((InternalEObject)iDNBZone).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - NahbedienbereichPackage.NB_ZONE_GRENZE__IDNB_ZONE, null, msgs);
			if (newIDNBZone != null)
				msgs = ((InternalEObject)newIDNBZone).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - NahbedienbereichPackage.NB_ZONE_GRENZE__IDNB_ZONE, null, msgs);
			msgs = basicSetIDNBZone(newIDNBZone, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_ZONE_GRENZE__IDNB_ZONE, newIDNBZone, newIDNBZone));
	}
