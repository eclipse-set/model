 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model1902.Nahbedienbereich.impl.Rang_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Rang_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Rang_TypeClass {
	...
	protected EClass eStaticClass() {
		return NahbedienbereichPackage.Literals.RANG_TYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.RANG_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, NahbedienbereichPackage.RANG_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
