...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.model.model11001.Geodaten.TOP_Knoten} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TOP_KnotenItemProvider extends Basis_ObjektItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TOP_KnotenItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GeodatenPackage.Literals.TOP_KNOTEN__IDGEO_KNOTEN);
			childrenFeatures.add(GeodatenPackage.Literals.TOP_KNOTEN__KNOTENNAME);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TOP_Knoten"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_TOP_Knoten_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TOP_Knoten.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GeodatenPackage.Literals.TOP_KNOTEN__IDGEO_KNOTEN,
				 VerweiseFactory.eINSTANCE.createID_GEO_Knoten_TypeClass()));

		newChildDescriptors.add
			(createChildParameter
				(GeodatenPackage.Literals.TOP_KNOTEN__KNOTENNAME,
