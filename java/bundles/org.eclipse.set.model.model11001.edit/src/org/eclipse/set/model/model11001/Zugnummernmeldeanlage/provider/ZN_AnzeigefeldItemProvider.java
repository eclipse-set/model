...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.model.model11001.Zugnummernmeldeanlage.ZN_Anzeigefeld} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ZN_AnzeigefeldItemProvider extends Basis_ObjektItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ZugnummernmeldeanlagePackage.Literals.ZN_ANZEIGEFELD__ID_GLEIS_ABSCHNITT);
			childrenFeatures.add(ZugnummernmeldeanlagePackage.Literals.ZN_ANZEIGEFELD__IDZLV_BUS);
			childrenFeatures.add(ZugnummernmeldeanlagePackage.Literals.ZN_ANZEIGEFELD__IDZN);
			childrenFeatures.add(ZugnummernmeldeanlagePackage.Literals.ZN_ANZEIGEFELD__IDZN_ANZEIGEFELD);
