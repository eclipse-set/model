...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.model.model11001.Schluesselabhaengigkeiten.Schloss_W_AttributeGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Schloss_W_AttributeGroupItemProvider 
	 ...
	 * @generated
	 */
	public Schloss_W_AttributeGroupItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SchluesselabhaengigkeitenPackage.Literals.SCHLOSS_WATTRIBUTE_GROUP__IDW_KR_ELEMENT);
	...
	/**
	 * This returns Schloss_W_AttributeGroup.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Schloss_W_AttributeGroup"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_Schloss_W_AttributeGroup_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SchluesselabhaengigkeitenPackage.Literals.SCHLOSS_WATTRIBUTE_GROUP__IDW_KR_ELEMENT,
				 VerweiseFactory.eINSTANCE.createID_W_Kr_Gsp_Element_TypeClass()));

		newChildDescriptors.add
			(createChildParameter
				(SchluesselabhaengigkeitenPackage.Literals.SCHLOSS_WATTRIBUTE_GROUP__SCHLOSS_ART,
				 SchluesselabhaengigkeitenFactory.eINSTANCE.createSchloss_Art_TypeClass()));
		...
		newChildDescriptors.add
			(createChildParameter
				(SchluesselabhaengigkeitenPackage.Literals.SCHLOSS_WATTRIBUTE_GROUP__WANBAULAGE,
				 SchluesselabhaengigkeitenFactory.eINSTANCE.createW_Anbaulage_TypeClass()));

		newChildDescriptors.add
			(createChildParameter
				(SchluesselabhaengigkeitenPackage.Literals.SCHLOSS_WATTRIBUTE_GROUP__WLAGE,
				 SchluesselabhaengigkeitenFactory.eINSTANCE.createW_Lage_TypeClass()));
	}
