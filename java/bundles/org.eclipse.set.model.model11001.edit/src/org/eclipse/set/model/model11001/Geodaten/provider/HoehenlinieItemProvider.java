...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.model.model11001.Geodaten.Hoehenlinie} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HoehenlinieItemProvider extends Basis_ObjektItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HoehenlinieItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Hoehenlinie"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_Hoehenlinie_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Hoehenlinie.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GeodatenPackage.Literals.HOEHENLINIE__HOEHENLINIE_ALLG,
				 GeodatenFactory.eINSTANCE.createHoehenlinie_Allg_AttributeGroup()));

		newChildDescriptors.add
			(createChildParameter
				(GeodatenPackage.Literals.HOEHENLINIE__ID_HOEHENPUNKT_A,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == GeodatenPackage.Literals.HOEHENLINIE__ID_HOEHENPUNKT_A ||
			childFeature == GeodatenPackage.Literals.HOEHENLINIE__ID_HOEHENPUNKT_B;
