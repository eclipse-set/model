...
public class PlanProPackageImpl extends EPackageImpl implements PlanProPackage {
	 ...
	 * @see org.eclipse.set.model.planpro.PlanPro.PlanProPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static PlanProPackage init() {
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(Signalbegriffe_Ril_301Package.eNS_URI);
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("org.eclipse.set.model.planpro.PlanPro." + eClassifier.getName());
