 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Balisentechnik_ETCS.impl.Bgrenze_Nach_PZB_Bed_Einstieg_AttributeGroupImpl#getIDWElement <em>IDW Element</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Balisentechnik_ETCS.impl.Bgrenze_Nach_PZB_Bed_Einstieg_AttributeGroupImpl#getWLage <em>WLage</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Bgrenze_Nach_PZB_Bed_Einstieg_AttributeGroupImpl extends EObjectImpl implements Bgrenze_Nach_PZB_Bed_Einstieg_AttributeGroup {
	...
	public NotificationChain basicSetIDWElement(ID_W_Kr_Gsp_Element_TypeClass newIDWElement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Balisentechnik_ETCSPackage.BGRENZE_NACH_PZB_BED_EINSTIEG_ATTRIBUTE_GROUP__IDW_ELEMENT, oldIDWElement, newIDWElement);
	...
	public void setIDWElement(ID_W_Kr_Gsp_Element_TypeClass newIDWElement) {
		if (newIDWElement != iDWElement) {
			...
			if (iDWElement != null)
				msgs = ((InternalEObject)iDWElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Balisentechnik_ETCSPackage.BGRENZE_NACH_PZB_BED_EINSTIEG_ATTRIBUTE_GROUP__IDW_ELEMENT, null, msgs);
			if (newIDWElement != null)
				msgs = ((InternalEObject)newIDWElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Balisentechnik_ETCSPackage.BGRENZE_NACH_PZB_BED_EINSTIEG_ATTRIBUTE_GROUP__IDW_ELEMENT, null, msgs);
			msgs = basicSetIDWElement(newIDWElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Balisentechnik_ETCSPackage.BGRENZE_NACH_PZB_BED_EINSTIEG_ATTRIBUTE_GROUP__IDW_ELEMENT, newIDWElement, newIDWElement));
	}
