...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ID Handschalt Wirkfunktion Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Verweise.impl.ID_Handschalt_Wirkfunktion_TypeClassImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Verweise.impl.ID_Handschalt_Wirkfunktion_TypeClassImpl#isInvalidReference <em>Invalid Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ID_Handschalt_Wirkfunktion_TypeClassImpl extends Zeiger_TypeClassImpl implements ID_Handschalt_Wirkfunktion_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected ID_Handschalt_Wirkfunktion_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return VerweisePackage.Literals.ID_HANDSCHALT_WIRKFUNKTION_TYPE_CLASS;
	}
		...
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VerweisePackage.ID_HANDSCHALT_WIRKFUNKTION_TYPE_CLASS__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setValue(Basis_Objekt newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VerweisePackage.ID_HANDSCHALT_WIRKFUNKTION_TYPE_CLASS__VALUE, oldValue, value));
	}
	...
	public void setInvalidReference(boolean newInvalidReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VerweisePackage.ID_HANDSCHALT_WIRKFUNKTION_TYPE_CLASS__INVALID_REFERENCE, oldInvalidReference, invalidReference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VerweisePackage.ID_HANDSCHALT_WIRKFUNKTION_TYPE_CLASS__VALUE:
...
} //ID_Handschalt_Wirkfunktion_TypeClassImpl
