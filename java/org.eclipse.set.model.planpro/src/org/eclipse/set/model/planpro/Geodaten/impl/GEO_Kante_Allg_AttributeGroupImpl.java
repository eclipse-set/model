 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Geodaten.impl.GEO_Kante_Allg_AttributeGroupImpl#getGEOForm <em>GEO Form</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Geodaten.impl.GEO_Kante_Allg_AttributeGroupImpl#getGEOKAD <em>GEOKAD</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Geodaten.impl.GEO_Kante_Allg_AttributeGroupImpl#getGEOLaenge <em>GEO Laenge</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Geodaten.impl.GEO_Kante_Allg_AttributeGroupImpl#getGEORadiusA <em>GEO Radius A</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Geodaten.impl.GEO_Kante_Allg_AttributeGroupImpl#getGEORadiusB <em>GEO Radius B</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Geodaten.impl.GEO_Kante_Allg_AttributeGroupImpl#getGEORichtungswinkel <em>GEO Richtungswinkel</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Geodaten.impl.GEO_Kante_Allg_AttributeGroupImpl#getPlanQuelle <em>Plan Quelle</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GEO_Kante_Allg_AttributeGroupImpl extends EObjectImpl implements GEO_Kante_Allg_AttributeGroup {
	/**
