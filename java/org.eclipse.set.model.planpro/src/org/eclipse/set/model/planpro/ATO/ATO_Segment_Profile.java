 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.ATO.ATO_Segment_Profile#getAbstandATOHaltVorEoA <em>Abstand ATO Halt Vor Eo A</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.ATO.ATO_Segment_Profile#getBezeichnung <em>Bezeichnung</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.ATO.ATO_Segment_Profile#getIDATOTSInstanz <em>IDATOTS Instanz</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.ATO.ATO_Segment_Profile#getIDATOTSInstanzNachbar <em>IDATOTS Instanz Nachbar</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.ATO.ATO_Segment_Profile#getIDETCSKante <em>IDETCS Kante</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.ATO.ATO_Segment_Profile#getIDOertlichkeit <em>ID Oertlichkeit</em>}</li>
 * </ul>
 *
 * @see org.eclipse.set.model.planpro.ATO.ATOPackage#getATO_Segment_Profile()
...
public interface ATO_Segment_Profile extends Basis_Objekt {
	 ...
	 * @see org.eclipse.set.model.planpro.ATO.ATOPackage#getATO_Segment_Profile_AbstandATOHaltVorEoA()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.ATO.ATO_Segment_Profile#getAbstandATOHaltVorEoA <em>Abstand ATO Halt Vor Eo A</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.planpro.ATO.ATOPackage#getATO_Segment_Profile_Bezeichnung()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.ATO.ATO_Segment_Profile#getBezeichnung <em>Bezeichnung</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.planpro.ATO.ATOPackage#getATO_Segment_Profile_IDATOTSInstanz()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.ATO.ATO_Segment_Profile#getIDATOTSInstanz <em>IDATOTS Instanz</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.planpro.ATO.ATOPackage#getATO_Segment_Profile_IDATOTSInstanzNachbar()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.ATO.ATO_Segment_Profile#getIDATOTSInstanzNachbar <em>IDATOTS Instanz Nachbar</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.planpro.ATO.ATOPackage#getATO_Segment_Profile_IDETCSKante()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.ATO.ATO_Segment_Profile#getIDETCSKante <em>IDETCS Kante</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link org.eclipse.set.model.planpro.Verweise.ID_Oertlichkeit_Proxy_TypeClass}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see org.eclipse.set.model.planpro.ATO.ATOPackage#getATO_Segment_Profile_IDOertlichkeit()
	 * @model containment="true"
