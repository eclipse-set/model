...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Index Ausgabe Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.PlanPro.impl.Index_Ausgabe_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Index_Ausgabe_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Index_Ausgabe_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Index_Ausgabe_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PlanProPackage.eINSTANCE.getIndex_Ausgabe_TypeClass();
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlanProPackage.INDEX_AUSGABE_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PlanProPackage.INDEX_AUSGABE_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
