 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Bahnuebergang.impl.BUE_Kreuzungsplan_Koordinaten_AttributeGroupImpl#getIDGEOPunkt <em>IDGEO Punkt</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Bahnuebergang.impl.BUE_Kreuzungsplan_Koordinaten_AttributeGroupImpl#getPixelKoordinateX <em>Pixel Koordinate X</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Bahnuebergang.impl.BUE_Kreuzungsplan_Koordinaten_AttributeGroupImpl#getPixelKoordinateY <em>Pixel Koordinate Y</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BUE_Kreuzungsplan_Koordinaten_AttributeGroupImpl extends EObjectImpl implements BUE_Kreuzungsplan_Koordinaten_AttributeGroup {
	/**
	...
	public EList<ID_GEO_Punkt_ohne_Proxy_TypeClass> getIDGEOPunkt() {
		if (iDGEOPunkt == null) {
			iDGEOPunkt = new EObjectContainmentEList<ID_GEO_Punkt_ohne_Proxy_TypeClass>(ID_GEO_Punkt_ohne_Proxy_TypeClass.class, this, BahnuebergangPackage.BUE_KREUZUNGSPLAN_KOORDINATEN_ATTRIBUTE_GROUP__IDGEO_PUNKT);
		}
		return iDGEOPunkt;
	}
