...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>NID CATOTS Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.ATO.impl.NID_C_ATOTS_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NID_C_ATOTS_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements NID_C_ATOTS_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected NID_C_ATOTS_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ATOPackage.Literals.NID_CATOTS_TYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ATOPackage.NID_CATOTS_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ATOPackage.NID_CATOTS_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
