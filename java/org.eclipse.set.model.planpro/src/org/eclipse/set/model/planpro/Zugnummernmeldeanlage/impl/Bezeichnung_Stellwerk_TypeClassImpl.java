...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bezeichnung Stellwerk Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Zugnummernmeldeanlage.impl.Bezeichnung_Stellwerk_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Bezeichnung_Stellwerk_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Bezeichnung_Stellwerk_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Bezeichnung_Stellwerk_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ZugnummernmeldeanlagePackage.Literals.BEZEICHNUNG_STELLWERK_TYPE_CLASS;
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZugnummernmeldeanlagePackage.BEZEICHNUNG_STELLWERK_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ZugnummernmeldeanlagePackage.BEZEICHNUNG_STELLWERK_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Bezeichnung_Stellwerk_TypeClassImpl
