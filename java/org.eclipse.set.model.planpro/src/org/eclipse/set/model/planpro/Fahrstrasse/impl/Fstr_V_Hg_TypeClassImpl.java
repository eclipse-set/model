...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Fstr VHg Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Fahrstrasse.impl.Fstr_V_Hg_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Fstr_V_Hg_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Fstr_V_Hg_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Fstr_V_Hg_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FahrstrassePackage.Literals.FSTR_VHG_TYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FahrstrassePackage.FSTR_VHG_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FahrstrassePackage.FSTR_VHG_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
