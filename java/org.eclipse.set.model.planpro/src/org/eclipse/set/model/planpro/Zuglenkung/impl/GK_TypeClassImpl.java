...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GK Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Zuglenkung.impl.GK_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GK_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements GK_TypeClass {
	/**
	...
	protected EClass eStaticClass() {
		return ZuglenkungPackage.Literals.GK_TYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZuglenkungPackage.GK_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ZuglenkungPackage.GK_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
