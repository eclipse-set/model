...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tv GK Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Zuglenkung.impl.Tv_GK_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Tv_GK_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Tv_GK_TypeClass {
	/**
	...
	protected EClass eStaticClass() {
		return ZuglenkungPackage.Literals.TV_GK_TYPE_CLASS;
	}
	...
	public void setWert(BigDecimal newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZuglenkungPackage.TV_GK_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ZuglenkungPackage.TV_GK_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
