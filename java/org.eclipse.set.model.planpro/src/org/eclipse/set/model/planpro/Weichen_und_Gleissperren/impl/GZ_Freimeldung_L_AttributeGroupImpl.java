 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Weichen_und_Gleissperren.impl.GZ_Freimeldung_L_AttributeGroupImpl#getElementLage <em>Element Lage</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Weichen_und_Gleissperren.impl.GZ_Freimeldung_L_AttributeGroupImpl#getIDElement <em>ID Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GZ_Freimeldung_L_AttributeGroupImpl extends EObjectImpl implements GZ_Freimeldung_L_AttributeGroup {
	/**
	...
	public NotificationChain basicSetIDElement(ID_Element_TypeClass newIDElement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Weichen_und_GleissperrenPackage.GZ_FREIMELDUNG_LATTRIBUTE_GROUP__ID_ELEMENT, oldIDElement, newIDElement);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIDElement(ID_Element_TypeClass newIDElement) {
		if (newIDElement != iDElement) {
			NotificationChain msgs = null;
			if (iDElement != null)
				msgs = ((InternalEObject)iDElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Weichen_und_GleissperrenPackage.GZ_FREIMELDUNG_LATTRIBUTE_GROUP__ID_ELEMENT, null, msgs);
			if (newIDElement != null)
				msgs = ((InternalEObject)newIDElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Weichen_und_GleissperrenPackage.GZ_FREIMELDUNG_LATTRIBUTE_GROUP__ID_ELEMENT, null, msgs);
			msgs = basicSetIDElement(newIDElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Weichen_und_GleissperrenPackage.GZ_FREIMELDUNG_LATTRIBUTE_GROUP__ID_ELEMENT, newIDElement, newIDElement));
	}
