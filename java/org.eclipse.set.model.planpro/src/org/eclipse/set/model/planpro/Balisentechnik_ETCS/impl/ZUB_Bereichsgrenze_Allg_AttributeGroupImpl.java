...
import org.eclipse.set.model.planpro.Balisentechnik_ETCS.System_Vor_Grenze_Besonders_TypeClass;
import org.eclipse.set.model.planpro.Balisentechnik_ETCS.System_Vor_Grenze_TypeClass;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Balisentechnik_ETCS.impl.ZUB_Bereichsgrenze_Allg_AttributeGroupImpl#getIDElementGrenze <em>ID Element Grenze</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Balisentechnik_ETCS.impl.ZUB_Bereichsgrenze_Allg_AttributeGroupImpl#getIDRBCVorGrenze <em>IDRBC Vor Grenze</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Balisentechnik_ETCS.impl.ZUB_Bereichsgrenze_Allg_AttributeGroupImpl#getSystemVorGrenze <em>System Vor Grenze</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Balisentechnik_ETCS.impl.ZUB_Bereichsgrenze_Allg_AttributeGroupImpl#getSystemVorGrenzeBesonders <em>System Vor Grenze Besonders</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ZUB_Bereichsgrenze_Allg_AttributeGroupImpl extends EObjectImpl implements ZUB_Bereichsgrenze_Allg_AttributeGroup {
	/**
	 * The cached value of the '{@link #getIDElementGrenze() <em>ID Element Grenze</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<ID_Element_Grenze_TypeClass> iDElementGrenze;
	 ...
	 */
	@Override
	public EList<ID_Element_Grenze_TypeClass> getIDElementGrenze() {
		if (iDElementGrenze == null) {
			iDElementGrenze = new EObjectContainmentEList<ID_Element_Grenze_TypeClass>(ID_Element_Grenze_TypeClass.class, this, Balisentechnik_ETCSPackage.ZUB_BEREICHSGRENZE_ALLG_ATTRIBUTE_GROUP__ID_ELEMENT_GRENZE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Balisentechnik_ETCSPackage.ZUB_BEREICHSGRENZE_ALLG_ATTRIBUTE_GROUP__ID_ELEMENT_GRENZE:
				return ((InternalEList<?>)getIDElementGrenze()).basicRemove(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Balisentechnik_ETCSPackage.ZUB_BEREICHSGRENZE_ALLG_ATTRIBUTE_GROUP__ID_ELEMENT_GRENZE:
				...
				getIDElementGrenze().addAll((Collection<? extends ID_Element_Grenze_TypeClass>)newValue);
				return;
			case Balisentechnik_ETCSPackage.ZUB_BEREICHSGRENZE_ALLG_ATTRIBUTE_GROUP__IDRBC_VOR_GRENZE:
