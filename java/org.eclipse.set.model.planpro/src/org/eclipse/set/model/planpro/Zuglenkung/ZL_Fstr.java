 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Zuglenkung.ZL_Fstr#getIDFstrZugRangier <em>ID Fstr Zug Rangier</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Zuglenkung.ZL_Fstr#getIDZL <em>IDZL</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Zuglenkung.ZL_Fstr#getIDZLFstr <em>IDZL Fstr</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Zuglenkung.ZL_Fstr#getZLFstrAllg <em>ZL Fstr Allg</em>}</li>
 * </ul>
 *
 * @see org.eclipse.set.model.planpro.Zuglenkung.ZuglenkungPackage#getZL_Fstr()
...
public interface ZL_Fstr extends Basis_Objekt {
	 ...
	 * @see org.eclipse.set.model.planpro.Zuglenkung.ZuglenkungPackage#getZL_Fstr_IDFstrZugRangier()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.Zuglenkung.ZL_Fstr#getIDFstrZugRangier <em>ID Fstr Zug Rangier</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.planpro.Zuglenkung.ZuglenkungPackage#getZL_Fstr_IDZL()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.Zuglenkung.ZL_Fstr#getIDZL <em>IDZL</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.planpro.Zuglenkung.ZuglenkungPackage#getZL_Fstr_IDZLFstr()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.Zuglenkung.ZL_Fstr#getIDZLFstr <em>IDZL Fstr</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.planpro.Zuglenkung.ZuglenkungPackage#getZL_Fstr_ZLFstrAllg()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.Zuglenkung.ZL_Fstr#getZLFstrAllg <em>ZL Fstr Allg</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
