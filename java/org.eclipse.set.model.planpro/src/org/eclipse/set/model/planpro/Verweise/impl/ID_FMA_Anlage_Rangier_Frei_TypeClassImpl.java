 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Verweise.impl.ID_FMA_Anlage_Rangier_Frei_TypeClassImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Verweise.impl.ID_FMA_Anlage_Rangier_Frei_TypeClassImpl#isInvalidReference <em>Invalid Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ID_FMA_Anlage_Rangier_Frei_TypeClassImpl extends Zeiger_TypeClassImpl implements ID_FMA_Anlage_Rangier_Frei_TypeClass {
		...
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VerweisePackage.ID_FMA_ANLAGE_RANGIER_FREI_TYPE_CLASS__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setValue(FMA_Anlage newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VerweisePackage.ID_FMA_ANLAGE_RANGIER_FREI_TYPE_CLASS__VALUE, oldValue, value));
	}
	...
	public void setInvalidReference(boolean newInvalidReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VerweisePackage.ID_FMA_ANLAGE_RANGIER_FREI_TYPE_CLASS__INVALID_REFERENCE, oldInvalidReference, invalidReference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VerweisePackage.ID_FMA_ANLAGE_RANGIER_FREI_TYPE_CLASS__VALUE:
