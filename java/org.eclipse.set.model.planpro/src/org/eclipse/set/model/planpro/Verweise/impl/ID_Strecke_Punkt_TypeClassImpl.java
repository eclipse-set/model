 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Verweise.impl.ID_Strecke_Punkt_TypeClassImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Verweise.impl.ID_Strecke_Punkt_TypeClassImpl#isInvalidReference <em>Invalid Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ID_Strecke_Punkt_TypeClassImpl extends Zeiger_TypeClassImpl implements ID_Strecke_Punkt_TypeClass {
	 ...
	 */
	@Override
	public Strecke_Punkt getValue() {
		if (value != null && value.eIsProxy()) {
			InternalEObject oldValue = (InternalEObject)value;
			value = (Strecke_Punkt)eResolveProxy(oldValue);
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VerweisePackage.ID_STRECKE_PUNKT_TYPE_CLASS__VALUE, oldValue, value));
			}
		}
		return value;
	}
	 ...
	 * @generated
	 */
	public Strecke_Punkt basicGetValue() {
		return value;
	}
	 ...
	 */
	@Override
	public void setValue(Strecke_Punkt newValue) {
		Strecke_Punkt oldValue = value;
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VerweisePackage.ID_STRECKE_PUNKT_TYPE_CLASS__VALUE, oldValue, value));
	}
	...
	public void setInvalidReference(boolean newInvalidReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VerweisePackage.ID_STRECKE_PUNKT_TYPE_CLASS__INVALID_REFERENCE, oldInvalidReference, invalidReference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VerweisePackage.ID_STRECKE_PUNKT_TYPE_CLASS__VALUE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case VerweisePackage.ID_STRECKE_PUNKT_TYPE_CLASS__VALUE:
				setValue((Strecke_Punkt)newValue);
				return;
			case VerweisePackage.ID_STRECKE_PUNKT_TYPE_CLASS__INVALID_REFERENCE:
