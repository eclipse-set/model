...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>DD Wert Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Bedienung.impl.DD_Wert_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DD_Wert_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements DD_Wert_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected DD_Wert_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return BedienungPackage.Literals.DD_WERT_TYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BedienungPackage.DD_WERT_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BedienungPackage.DD_WERT_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
