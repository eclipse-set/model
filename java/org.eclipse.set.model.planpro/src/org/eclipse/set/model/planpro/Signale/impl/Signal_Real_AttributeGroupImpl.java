 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Signale.impl.Signal_Real_AttributeGroupImpl#getDunkelschaltung <em>Dunkelschaltung</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Signale.impl.Signal_Real_AttributeGroupImpl#getFunktionOhneSignal <em>Funktion Ohne Signal</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Signale.impl.Signal_Real_AttributeGroupImpl#getGeltungsbereich <em>Geltungsbereich</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Signale.impl.Signal_Real_AttributeGroupImpl#getSignalBefestigungsart <em>Signal Befestigungsart</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Signale.impl.Signal_Real_AttributeGroupImpl#getSignalFunktion <em>Signal Funktion</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Signale.impl.Signal_Real_AttributeGroupImpl#getSignalRealAktiv <em>Signal Real Aktiv</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Signale.impl.Signal_Real_AttributeGroupImpl#getSignalRealAktivSchirm <em>Signal Real Aktiv Schirm</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Signale.impl.Signal_Real_AttributeGroupImpl#getSignalsichtErreichbar <em>Signalsicht Erreichbar</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Signale.impl.Signal_Real_AttributeGroupImpl#getSignalsichtMindest <em>Signalsicht Mindest</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Signale.impl.Signal_Real_AttributeGroupImpl#getSignalsichtSoll <em>Signalsicht Soll</em>}</li>
 * </ul>
 *
 * @generated
 */
