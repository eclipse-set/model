...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>DWeg Prio Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Zuglenkung.impl.DWeg_Prio_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DWeg_Prio_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements DWeg_Prio_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected DWeg_Prio_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ZuglenkungPackage.Literals.DWEG_PRIO_TYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZuglenkungPackage.DWEG_PRIO_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ZuglenkungPackage.DWEG_PRIO_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
