...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ID Signal Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Verweise.impl.ID_Signal_TypeClassImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Verweise.impl.ID_Signal_TypeClassImpl#isInvalidReference <em>Invalid Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ID_Signal_TypeClassImpl extends Zeiger_TypeClassImpl implements ID_Signal_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected ID_Signal_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return VerweisePackage.Literals.ID_SIGNAL_TYPE_CLASS;
	}
		...
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VerweisePackage.ID_SIGNAL_TYPE_CLASS__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setValue(Signal newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VerweisePackage.ID_SIGNAL_TYPE_CLASS__VALUE, oldValue, value));
	}
	...
	public void setInvalidReference(boolean newInvalidReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VerweisePackage.ID_SIGNAL_TYPE_CLASS__INVALID_REFERENCE, oldInvalidReference, invalidReference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VerweisePackage.ID_SIGNAL_TYPE_CLASS__VALUE:
