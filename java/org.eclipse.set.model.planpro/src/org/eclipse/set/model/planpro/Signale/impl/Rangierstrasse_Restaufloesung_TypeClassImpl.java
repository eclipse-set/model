...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Rangierstrasse Restaufloesung Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Signale.impl.Rangierstrasse_Restaufloesung_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Rangierstrasse_Restaufloesung_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Rangierstrasse_Restaufloesung_TypeClass {
	 ...
	 * @generated
	 */
	protected Rangierstrasse_Restaufloesung_TypeClassImpl() {
		super();
	}
	...
	public void setWert(Boolean newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SignalePackage.RANGIERSTRASSE_RESTAUFLOESUNG_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SignalePackage.RANGIERSTRASSE_RESTAUFLOESUNG_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Rangierstrasse_Restaufloesung_TypeClassImpl
