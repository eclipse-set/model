...
import org.eclipse.set.model.planpro.Block.Auto_Erlaubnisholen_TypeClass;
import org.eclipse.set.model.planpro.Block.Auto_Erlaubnisruecklauf_TypeClass;
import org.eclipse.set.model.planpro.Block.Betriebsfuehrung_TypeClass;
...
import org.eclipse.set.model.planpro.Block.Block_Anlage_Allg_AttributeGroup;
import org.eclipse.set.model.planpro.Block.Block_Bauform_TypeClass;
import org.eclipse.set.model.planpro.Block.Block_Element;
import org.eclipse.set.model.planpro.Block.Block_Element_Allg_AttributeGroup;
import org.eclipse.set.model.planpro.Block.Block_Element_Erlaubnis_AttributeGroup;
import org.eclipse.set.model.planpro.Block.Block_Strecke;
import org.eclipse.set.model.planpro.Block.Block_Strecke_Allg_AttributeGroup;
import org.eclipse.set.model.planpro.Block.Bremsweg_TypeClass;
import org.eclipse.set.model.planpro.Block.ENUMBetriebsfuehrung;
import org.eclipse.set.model.planpro.Block.ENUMBlockBauform;
import org.eclipse.set.model.planpro.Block.ENUMSchaltung;
import org.eclipse.set.model.planpro.Block.ENUMStreckeArt;
import org.eclipse.set.model.planpro.Block.Erlaubnis_Staendig_Vorhanden_TypeClass;
import org.eclipse.set.model.planpro.Block.Erlaubnisabgabespeicherung_TypeClass;
import org.eclipse.set.model.planpro.Block.Erlaubnisholen_TypeClass;
import org.eclipse.set.model.planpro.Block.Rueckblockwecker_TypeClass;
import org.eclipse.set.model.planpro.Block.Schaltung_TypeClass;
import org.eclipse.set.model.planpro.Block.Schutzuebertrager_TypeClass;
import org.eclipse.set.model.planpro.Block.Strecke_Art_TypeClass;
import org.eclipse.set.model.planpro.Block.Streckengeschwindigkeit_TypeClass;
import org.eclipse.set.model.planpro.Block.Traktion_Art_Elektrisch_TypeClass;
import org.eclipse.set.model.planpro.Block.Vorblockwecker_TypeClass;
import org.eclipse.set.model.planpro.Block.Zugbeeinflussung_Art_TypeClass;
import org.eclipse.set.model.planpro.Block.Zusatzinformation_TypeClass;

import org.eclipse.set.model.planpro.Block.util.BlockValidator;
...
public class BlockPackageImpl extends EPackageImpl implements BlockPackage {
	 ...
	 * @see org.eclipse.set.model.planpro.Block.BlockPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getBlock_Anlage_IDBlockElementA(), theVerweisePackage.getID_Block_Element_TypeClass(), null, "iDBlockElementA", null, 1, 1, Block_Anlage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlock_Anlage_IDBlockElementB(), theVerweisePackage.getID_Block_Element_TypeClass(), null, "iDBlockElementB", null, 0, 1, Block_Anlage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlock_Anlage_IDGleisBezeichnung(), theVerweisePackage.getID_Gleis_Bezeichnung_TypeClass(), null, "iDGleisBezeichnung", null, 1, 1, Block_Anlage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBlock_Element_IDBlockStrecke(), theVerweisePackage.getID_Block_Strecke_TypeClass(), null, "iDBlockStrecke", null, 1, 1, Block_Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlock_Element_IDRaeumungspruefung(), theVerweisePackage.getID_Schaltmittel_Zuordnung_TypeClass(), null, "iDRaeumungspruefung", null, 0, 1, Block_Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlock_Element_IDSignal(), theVerweisePackage.getID_Signal_TypeClass(), null, "iDSignal", null, 1, 1, Block_Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlock_Element_IDZugschlussmeldung(), theVerweisePackage.getID_Bedien_Anzeige_Element_TypeClass(), null, "iDZugschlussmeldung", null, 0, 1, Block_Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBlock_Strecke_IDBetriebsstelleNachbar(), theVerweisePackage.getID_Oertlichkeit_Proxy_TypeClass(), null, "iDBetriebsstelleNachbar", null, 1, 1, Block_Strecke.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlock_Strecke_IDKnotenbahnhof(), theVerweisePackage.getID_Oertlichkeit_Proxy_TypeClass(), null, "iDKnotenbahnhof", null, 0, 1, Block_Strecke.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlock_Strecke_IDStrecke(), theVerweisePackage.getID_Strecke_TypeClass(), null, "iDStrecke", null, 1, 1, Block_Strecke.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlock_Strecke_IDStreckeBremsweg(), theVerweisePackage.getID_Strecke_Bremsweg_ohne_Proxy_TypeClass(), null, "iDStreckeBremsweg", null, 0, 1, Block_Strecke.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
