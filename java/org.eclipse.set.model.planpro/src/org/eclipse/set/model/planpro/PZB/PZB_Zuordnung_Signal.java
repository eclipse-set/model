 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.PZB.PZB_Zuordnung_Signal#getIDPZBElementZuordnung <em>IDPZB Element Zuordnung</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.PZB.PZB_Zuordnung_Signal#getIDSignal <em>ID Signal</em>}</li>
 * </ul>
 *
 * @see org.eclipse.set.model.planpro.PZB.PZBPackage#getPZB_Zuordnung_Signal()
...
public interface PZB_Zuordnung_Signal extends Basis_Objekt {
	 ...
	 * @see org.eclipse.set.model.planpro.PZB.PZBPackage#getPZB_Zuordnung_Signal_IDPZBElementZuordnung()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.PZB.PZB_Zuordnung_Signal#getIDPZBElementZuordnung <em>IDPZB Element Zuordnung</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.planpro.PZB.PZBPackage#getPZB_Zuordnung_Signal_IDSignal()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.PZB.PZB_Zuordnung_Signal#getIDSignal <em>ID Signal</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
