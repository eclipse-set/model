 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Verweise.impl.ID_W_Kr_Gsp_Komponente_TypeClassImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Verweise.impl.ID_W_Kr_Gsp_Komponente_TypeClassImpl#isInvalidReference <em>Invalid Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ID_W_Kr_Gsp_Komponente_TypeClassImpl extends Zeiger_TypeClassImpl implements ID_W_Kr_Gsp_Komponente_TypeClass {
	 ...
	 * @ordered
	 */
	protected W_Kr_Gsp_Komponente value;
	/**
	 ...
	 */
	@Override
	public W_Kr_Gsp_Komponente getValue() {
		if (value != null && value.eIsProxy()) {
			InternalEObject oldValue = (InternalEObject)value;
			value = (W_Kr_Gsp_Komponente)eResolveProxy(oldValue);
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VerweisePackage.ID_WKR_GSP_KOMPONENTE_TYPE_CLASS__VALUE, oldValue, value));
			}
		}
		return value;
	}
	 ...
	 * @generated
	 */
	public W_Kr_Gsp_Komponente basicGetValue() {
		return value;
	}
	 ...
	 */
	@Override
	public void setValue(W_Kr_Gsp_Komponente newValue) {
		W_Kr_Gsp_Komponente oldValue = value;
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VerweisePackage.ID_WKR_GSP_KOMPONENTE_TYPE_CLASS__VALUE, oldValue, value));
	}
	...
	public void setInvalidReference(boolean newInvalidReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VerweisePackage.ID_WKR_GSP_KOMPONENTE_TYPE_CLASS__INVALID_REFERENCE, oldInvalidReference, invalidReference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VerweisePackage.ID_WKR_GSP_KOMPONENTE_TYPE_CLASS__VALUE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case VerweisePackage.ID_WKR_GSP_KOMPONENTE_TYPE_CLASS__VALUE:
				setValue((W_Kr_Gsp_Komponente)newValue);
				return;
			case VerweisePackage.ID_WKR_GSP_KOMPONENTE_TYPE_CLASS__INVALID_REFERENCE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case VerweisePackage.ID_WKR_GSP_KOMPONENTE_TYPE_CLASS__VALUE:
				setValue((W_Kr_Gsp_Komponente)null);
				return;
			case VerweisePackage.ID_WKR_GSP_KOMPONENTE_TYPE_CLASS__INVALID_REFERENCE:
