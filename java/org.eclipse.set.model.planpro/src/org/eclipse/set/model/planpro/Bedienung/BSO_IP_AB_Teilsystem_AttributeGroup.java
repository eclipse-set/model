 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Bedienung.BSO_IP_AB_Teilsystem_AttributeGroup#getBSOTeilsystemArt <em>BSO Teilsystem Art</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Bedienung.BSO_IP_AB_Teilsystem_AttributeGroup#getIPAdressblockBlau <em>IP Adressblock Blau</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Bedienung.BSO_IP_AB_Teilsystem_AttributeGroup#getIPAdressblockGrau <em>IP Adressblock Grau</em>}</li>
 * </ul>
 *
 * @see org.eclipse.set.model.planpro.Bedienung.BedienungPackage#getBSO_IP_AB_Teilsystem_AttributeGroup()
...
public interface BSO_IP_AB_Teilsystem_AttributeGroup extends EObject {
	 ...
	 * @see org.eclipse.set.model.planpro.Bedienung.BedienungPackage#getBSO_IP_AB_Teilsystem_AttributeGroup_BSOTeilsystemArt()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.Bedienung.BSO_IP_AB_Teilsystem_AttributeGroup#getBSOTeilsystemArt <em>BSO Teilsystem Art</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.planpro.Bedienung.BedienungPackage#getBSO_IP_AB_Teilsystem_AttributeGroup_IPAdressblockBlau()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.Bedienung.BSO_IP_AB_Teilsystem_AttributeGroup#getIPAdressblockBlau <em>IP Adressblock Blau</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.planpro.Bedienung.BedienungPackage#getBSO_IP_AB_Teilsystem_AttributeGroup_IPAdressblockGrau()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.Bedienung.BSO_IP_AB_Teilsystem_AttributeGroup#getIPAdressblockGrau <em>IP Adressblock Grau</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
