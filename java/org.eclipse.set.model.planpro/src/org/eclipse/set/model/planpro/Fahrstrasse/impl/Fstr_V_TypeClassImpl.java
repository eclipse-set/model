...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Fstr VType Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Fahrstrasse.impl.Fstr_V_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Fstr_V_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Fstr_V_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Fstr_V_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FahrstrassePackage.Literals.FSTR_VTYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FahrstrassePackage.FSTR_VTYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FahrstrassePackage.FSTR_VTYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
