...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>YY Wert Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Bedienung.impl.YY_Wert_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class YY_Wert_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements YY_Wert_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected YY_Wert_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return BedienungPackage.Literals.YY_WERT_TYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BedienungPackage.YY_WERT_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BedienungPackage.YY_WERT_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
