 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Geodaten.TOP_Kante_Allg_AttributeGroup#getKantenname <em>Kantenname</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Geodaten.TOP_Kante_Allg_AttributeGroup#getTOPAnschlussA <em>TOP Anschluss A</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Geodaten.TOP_Kante_Allg_AttributeGroup#getTOPAnschlussB <em>TOP Anschluss B</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Geodaten.TOP_Kante_Allg_AttributeGroup#getTOPLaenge <em>TOP Laenge</em>}</li>
 * </ul>
 *
 * @see org.eclipse.set.model.planpro.Geodaten.GeodatenPackage#getTOP_Kante_Allg_AttributeGroup()
...
public interface TOP_Kante_Allg_AttributeGroup extends EObject {
	 ...
	 * @see org.eclipse.set.model.planpro.Geodaten.GeodatenPackage#getTOP_Kante_Allg_AttributeGroup_Kantenname()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.Geodaten.TOP_Kante_Allg_AttributeGroup#getKantenname <em>Kantenname</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.planpro.Geodaten.GeodatenPackage#getTOP_Kante_Allg_AttributeGroup_TOPAnschlussA()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.Geodaten.TOP_Kante_Allg_AttributeGroup#getTOPAnschlussA <em>TOP Anschluss A</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.planpro.Geodaten.GeodatenPackage#getTOP_Kante_Allg_AttributeGroup_TOPAnschlussB()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.Geodaten.TOP_Kante_Allg_AttributeGroup#getTOPAnschlussB <em>TOP Anschluss B</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.planpro.Geodaten.GeodatenPackage#getTOP_Kante_Allg_AttributeGroup_TOPLaenge()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.Geodaten.TOP_Kante_Allg_AttributeGroup#getTOPLaenge <em>TOP Laenge</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
