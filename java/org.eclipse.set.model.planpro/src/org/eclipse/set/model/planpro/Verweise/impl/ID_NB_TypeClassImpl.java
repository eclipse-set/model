 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Verweise.impl.ID_NB_TypeClassImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Verweise.impl.ID_NB_TypeClassImpl#isInvalidReference <em>Invalid Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ID_NB_TypeClassImpl extends Zeiger_TypeClassImpl implements ID_NB_TypeClass {
	...
	public NB getValue() {
		if (value != null && value.eIsProxy()) {
			...
			value = (NB)eResolveProxy(oldValue);
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VerweisePackage.ID_NB_TYPE_CLASS__VALUE, oldValue, value));
			}
		}
		return value;
	}
	 ...
	 */
	@Override
	public void setValue(NB newValue) {
		NB oldValue = value;
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VerweisePackage.ID_NB_TYPE_CLASS__VALUE, oldValue, value));
	}
	...
	public void setInvalidReference(boolean newInvalidReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VerweisePackage.ID_NB_TYPE_CLASS__INVALID_REFERENCE, oldInvalidReference, invalidReference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VerweisePackage.ID_NB_TYPE_CLASS__VALUE:
