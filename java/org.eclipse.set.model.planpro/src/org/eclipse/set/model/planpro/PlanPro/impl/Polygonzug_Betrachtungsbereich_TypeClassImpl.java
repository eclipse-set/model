 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.PlanPro.impl.Polygonzug_Betrachtungsbereich_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Polygonzug_Betrachtungsbereich_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Polygonzug_Betrachtungsbereich_TypeClass {
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlanProPackage.POLYGONZUG_BETRACHTUNGSBEREICH_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PlanProPackage.POLYGONZUG_BETRACHTUNGSBEREICH_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
