...
import org.eclipse.set.model.planpro.Medien_und_Trassen.Ader_Durchmesser_TypeClass;
import org.eclipse.set.model.planpro.Medien_und_Trassen.Ader_Querschnitt_TypeClass;
import org.eclipse.set.model.planpro.Medien_und_Trassen.Ader_Reserve_TypeClass;
import org.eclipse.set.model.planpro.Medien_und_Trassen.Anzahl_Verseilelemente_TypeClass;
import org.eclipse.set.model.planpro.Medien_und_Trassen.Bezeichnung_Kabel_TypeClass;
import org.eclipse.set.model.planpro.Medien_und_Trassen.Bezeichnung_Kabel_Verteilpunkt_TypeClass;
import org.eclipse.set.model.planpro.Medien_und_Trassen.ENUMKabelArt;
import org.eclipse.set.model.planpro.Medien_und_Trassen.ENUMKabelVerteilpunktArt;
import org.eclipse.set.model.planpro.Medien_und_Trassen.ENUMTrasseKanteArt;
import org.eclipse.set.model.planpro.Medien_und_Trassen.ENUMTrasseKnotenArt;
import org.eclipse.set.model.planpro.Medien_und_Trassen.ENUMTrasseNutzer;
import org.eclipse.set.model.planpro.Medien_und_Trassen.Induktionsschutz_TypeClass;
import org.eclipse.set.model.planpro.Medien_und_Trassen.Kabel;
import org.eclipse.set.model.planpro.Medien_und_Trassen.Kabel_Allg_AttributeGroup;
import org.eclipse.set.model.planpro.Medien_und_Trassen.Kabel_Art_TypeClass;
import org.eclipse.set.model.planpro.Medien_und_Trassen.Kabel_Bezeichnung_AttributeGroup;
import org.eclipse.set.model.planpro.Medien_und_Trassen.Kabel_Element_AttributeGroup;
import org.eclipse.set.model.planpro.Medien_und_Trassen.Kabel_Laenge_TypeClass;
import org.eclipse.set.model.planpro.Medien_und_Trassen.Kabel_Typ_TypeClass;
...
import org.eclipse.set.model.planpro.Medien_und_Trassen.Kabel_Verteilpunkt_Bezeichnung_AttributeGroup;
...
import org.eclipse.set.model.planpro.Medien_und_Trassen.Nagetierschutz_TypeClass;
import org.eclipse.set.model.planpro.Medien_und_Trassen.Trasse_Kante;
import org.eclipse.set.model.planpro.Medien_und_Trassen.Trasse_Kante_Art_TypeClass;
...
import org.eclipse.set.model.planpro.Medien_und_Trassen.Trasse_Nutzer_TypeClass;
import org.eclipse.set.model.planpro.Medien_und_Trassen.Verseilart_TypeClass;

import org.eclipse.set.model.planpro.Medien_und_Trassen.util.Medien_und_TrassenValidator;
...
public class Medien_und_TrassenPackageImpl extends EPackageImpl implements Medien_und_TrassenPackage {
	 ...
	 * @see org.eclipse.set.model.planpro.Medien_und_Trassen.Medien_und_TrassenPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getKabel_IDTrasseKante(), theVerweisePackage.getID_Trasse_Kante_TypeClass(), null, "iDTrasseKante", null, 0, -1, Kabel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getKabel_Verteilpunkt_IDUnterbringung(), theVerweisePackage.getID_Unterbringung_TypeClass(), null, "iDUnterbringung", null, 1, 1, Kabel_Verteilpunkt.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTrasse_Kante_IDTrasseKnotenA(), theVerweisePackage.getID_Trasse_Knoten_TypeClass(), null, "iDTrasseKnotenA", null, 1, 1, Trasse_Kante.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTrasse_Kante_IDTrasseKnotenB(), theVerweisePackage.getID_Trasse_Knoten_TypeClass(), null, "iDTrasseKnotenB", null, 1, 1, Trasse_Kante.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTrasse_Knoten_IDAnschlussElement(), theVerweisePackage.getID_Anschluss_Element_TypeClass(), null, "iDAnschlussElement", null, 0, -1, Trasse_Knoten.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTrasse_Knoten_IDGEOKnoten(), theVerweisePackage.getID_GEO_Knoten_TypeClass(), null, "iDGEOKnoten", null, 1, 1, Trasse_Knoten.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
