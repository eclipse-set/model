 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Verweise.impl.ID_FT_Fahrweg_Teil_TypeClassImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Verweise.impl.ID_FT_Fahrweg_Teil_TypeClassImpl#isInvalidReference <em>Invalid Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ID_FT_Fahrweg_Teil_TypeClassImpl extends Zeiger_TypeClassImpl implements ID_FT_Fahrweg_Teil_TypeClass {
	 ...
	 * @ordered
	 */
	protected FT_Fahrweg_Teil value;
	/**
	 ...
	 */
	@Override
	public FT_Fahrweg_Teil getValue() {
		if (value != null && value.eIsProxy()) {
			InternalEObject oldValue = (InternalEObject)value;
			value = (FT_Fahrweg_Teil)eResolveProxy(oldValue);
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VerweisePackage.ID_FT_FAHRWEG_TEIL_TYPE_CLASS__VALUE, oldValue, value));
			}
		}
		return value;
	}
	 ...
	 * @generated
	 */
	public FT_Fahrweg_Teil basicGetValue() {
		return value;
	}
	 ...
	 */
	@Override
	public void setValue(FT_Fahrweg_Teil newValue) {
		FT_Fahrweg_Teil oldValue = value;
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VerweisePackage.ID_FT_FAHRWEG_TEIL_TYPE_CLASS__VALUE, oldValue, value));
	}
	...
	public void setInvalidReference(boolean newInvalidReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VerweisePackage.ID_FT_FAHRWEG_TEIL_TYPE_CLASS__INVALID_REFERENCE, oldInvalidReference, invalidReference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VerweisePackage.ID_FT_FAHRWEG_TEIL_TYPE_CLASS__VALUE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case VerweisePackage.ID_FT_FAHRWEG_TEIL_TYPE_CLASS__VALUE:
				setValue((FT_Fahrweg_Teil)newValue);
				return;
			case VerweisePackage.ID_FT_FAHRWEG_TEIL_TYPE_CLASS__INVALID_REFERENCE:
