 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Fahrstrasse.Markanter_Punkt#getBezeichnung <em>Bezeichnung</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Fahrstrasse.Markanter_Punkt#getIDDWegErlaubnisabhaengig <em>IDD Weg Erlaubnisabhaengig</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Fahrstrasse.Markanter_Punkt#getIDMarkanteStelle <em>ID Markante Stelle</em>}</li>
 * </ul>
 *
 * @see org.eclipse.set.model.planpro.Fahrstrasse.FahrstrassePackage#getMarkanter_Punkt()
...
public interface Markanter_Punkt extends Basis_Objekt {
	 ...
	 * @see org.eclipse.set.model.planpro.Fahrstrasse.FahrstrassePackage#getMarkanter_Punkt_Bezeichnung()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.Fahrstrasse.Markanter_Punkt#getBezeichnung <em>Bezeichnung</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.planpro.Fahrstrasse.FahrstrassePackage#getMarkanter_Punkt_IDDWegErlaubnisabhaengig()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.Fahrstrasse.Markanter_Punkt#getIDDWegErlaubnisabhaengig <em>IDD Weg Erlaubnisabhaengig</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.planpro.Fahrstrasse.FahrstrassePackage#getMarkanter_Punkt_IDMarkanteStelle()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.planpro.Fahrstrasse.Markanter_Punkt#getIDMarkanteStelle <em>ID Markante Stelle</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
