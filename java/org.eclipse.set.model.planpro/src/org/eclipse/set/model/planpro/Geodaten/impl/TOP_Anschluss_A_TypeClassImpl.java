...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TOP Anschluss AType Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Geodaten.impl.TOP_Anschluss_A_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TOP_Anschluss_A_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements TOP_Anschluss_A_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected TOP_Anschluss_A_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GeodatenPackage.Literals.TOP_ANSCHLUSS_ATYPE_CLASS;
	}
	...
	public void setWert(ENUMTOPAnschluss newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeodatenPackage.TOP_ANSCHLUSS_ATYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GeodatenPackage.TOP_ANSCHLUSS_ATYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
