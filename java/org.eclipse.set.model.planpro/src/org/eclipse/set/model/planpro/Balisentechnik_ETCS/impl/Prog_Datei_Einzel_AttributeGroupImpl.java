...
import org.eclipse.set.model.planpro.Balisentechnik_ETCS.Anzeigetext_TypeClass;
import org.eclipse.set.model.planpro.Balisentechnik_ETCS.Balisentechnik_ETCSPackage;
import org.eclipse.set.model.planpro.Balisentechnik_ETCS.Einzeldatei_Art_TypeClass;
import org.eclipse.set.model.planpro.Balisentechnik_ETCS.Konfigurationskennung_TypeClass;
import org.eclipse.set.model.planpro.Balisentechnik_ETCS.Prog_Datei_Einzel_AttributeGroup;
import org.eclipse.set.model.planpro.Balisentechnik_ETCS.Verwendung_TypeClass;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Balisentechnik_ETCS.impl.Prog_Datei_Einzel_AttributeGroupImpl#getAnzeigetext <em>Anzeigetext</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Balisentechnik_ETCS.impl.Prog_Datei_Einzel_AttributeGroupImpl#getEinzeldateiArt <em>Einzeldatei Art</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Balisentechnik_ETCS.impl.Prog_Datei_Einzel_AttributeGroupImpl#getIDBinaerdatei <em>ID Binaerdatei</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Balisentechnik_ETCS.impl.Prog_Datei_Einzel_AttributeGroupImpl#getKonfigurationskennung <em>Konfigurationskennung</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Balisentechnik_ETCS.impl.Prog_Datei_Einzel_AttributeGroupImpl#getPruefmerkmaleBinaerdatei <em>Pruefmerkmale Binaerdatei</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Balisentechnik_ETCS.impl.Prog_Datei_Einzel_AttributeGroupImpl#getPruefmerkmaleProgKomponente <em>Pruefmerkmale Prog Komponente</em>}</li>
 *   <li>{@link org.eclipse.set.model.planpro.Balisentechnik_ETCS.impl.Prog_Datei_Einzel_AttributeGroupImpl#getVerwendung <em>Verwendung</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Prog_Datei_Einzel_AttributeGroupImpl extends EObjectImpl implements Prog_Datei_Einzel_AttributeGroup {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIDBinaerdatei(ID_Binaerdaten_ohne_Proxy_TypeClass newIDBinaerdatei, NotificationChain msgs) {
		ID_Binaerdaten_ohne_Proxy_TypeClass oldIDBinaerdatei = iDBinaerdatei;
	 ...
	 */
	@Override
	public void setIDBinaerdatei(ID_Binaerdaten_ohne_Proxy_TypeClass newIDBinaerdatei) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Balisentechnik_ETCSPackage.PROG_DATEI_EINZEL_ATTRIBUTE_GROUP__EINZELDATEI_ART:
				...
				return;
			case Balisentechnik_ETCSPackage.PROG_DATEI_EINZEL_ATTRIBUTE_GROUP__ID_BINAERDATEI:
				setIDBinaerdatei((ID_Binaerdaten_ohne_Proxy_TypeClass)newValue);
				return;
			case Balisentechnik_ETCSPackage.PROG_DATEI_EINZEL_ATTRIBUTE_GROUP__KONFIGURATIONSKENNUNG:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case Balisentechnik_ETCSPackage.PROG_DATEI_EINZEL_ATTRIBUTE_GROUP__EINZELDATEI_ART:
				...
				return;
			case Balisentechnik_ETCSPackage.PROG_DATEI_EINZEL_ATTRIBUTE_GROUP__ID_BINAERDATEI:
				setIDBinaerdatei((ID_Binaerdaten_ohne_Proxy_TypeClass)null);
				return;
			case Balisentechnik_ETCSPackage.PROG_DATEI_EINZEL_ATTRIBUTE_GROUP__KONFIGURATIONSKENNUNG:
