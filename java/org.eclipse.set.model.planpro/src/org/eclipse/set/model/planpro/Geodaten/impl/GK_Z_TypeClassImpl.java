...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GK ZType Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.planpro.Geodaten.impl.GK_Z_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GK_Z_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements GK_Z_TypeClass {
	/**
	...
	protected EClass eStaticClass() {
		return GeodatenPackage.Literals.GK_ZTYPE_CLASS;
	}
	...
	public void setWert(BigDecimal newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeodatenPackage.GK_ZTYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GeodatenPackage.GK_ZTYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
