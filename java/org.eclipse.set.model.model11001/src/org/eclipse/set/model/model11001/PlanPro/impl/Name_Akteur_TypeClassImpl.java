...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Name Akteur Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.PlanPro.impl.Name_Akteur_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Name_Akteur_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Name_Akteur_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Name_Akteur_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PlanProPackage.eINSTANCE.getName_Akteur_TypeClass();
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlanProPackage.NAME_AKTEUR_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PlanProPackage.NAME_AKTEUR_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
