...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>WAnbaulage Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Schluesselabhaengigkeiten.impl.W_Anbaulage_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class W_Anbaulage_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements W_Anbaulage_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected W_Anbaulage_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SchluesselabhaengigkeitenPackage.Literals.WANBAULAGE_TYPE_CLASS;
	}
	...
	public void setWert(ENUMLinksRechts newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchluesselabhaengigkeitenPackage.WANBAULAGE_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SchluesselabhaengigkeitenPackage.WANBAULAGE_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
