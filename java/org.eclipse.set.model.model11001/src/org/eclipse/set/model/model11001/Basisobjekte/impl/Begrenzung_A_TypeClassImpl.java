...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Begrenzung AType Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Basisobjekte.impl.Begrenzung_A_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Begrenzung_A_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Begrenzung_A_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Begrenzung_A_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return BasisobjektePackage.Literals.BEGRENZUNG_ATYPE_CLASS;
	}
	...
	public void setWert(BigDecimal newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisobjektePackage.BEGRENZUNG_ATYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BasisobjektePackage.BEGRENZUNG_ATYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
