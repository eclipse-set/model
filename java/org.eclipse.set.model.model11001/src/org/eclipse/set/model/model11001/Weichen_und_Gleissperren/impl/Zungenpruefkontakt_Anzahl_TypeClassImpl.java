...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Zungenpruefkontakt Anzahl Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Weichen_und_Gleissperren.impl.Zungenpruefkontakt_Anzahl_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Zungenpruefkontakt_Anzahl_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Zungenpruefkontakt_Anzahl_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Zungenpruefkontakt_Anzahl_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Weichen_und_GleissperrenPackage.Literals.ZUNGENPRUEFKONTAKT_ANZAHL_TYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Weichen_und_GleissperrenPackage.ZUNGENPRUEFKONTAKT_ANZAHL_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Weichen_und_GleissperrenPackage.ZUNGENPRUEFKONTAKT_ANZAHL_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Zungenpruefkontakt_Anzahl_TypeClassImpl
