...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ESG Ind Parameterwert Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Balisentechnik_ETCS.impl.ESG_Ind_Parameterwert_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ESG_Ind_Parameterwert_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements ESG_Ind_Parameterwert_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected ESG_Ind_Parameterwert_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Balisentechnik_ETCSPackage.eINSTANCE.getESG_Ind_Parameterwert_TypeClass();
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Balisentechnik_ETCSPackage.ESG_IND_PARAMETERWERT_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Balisentechnik_ETCSPackage.ESG_IND_PARAMETERWERT_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //ESG_Ind_Parameterwert_TypeClassImpl
