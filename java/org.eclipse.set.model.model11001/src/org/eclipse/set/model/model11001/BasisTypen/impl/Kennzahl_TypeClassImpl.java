 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.BasisTypen.impl.Kennzahl_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Kennzahl_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Kennzahl_TypeClass {
	...
	protected EClass eStaticClass() {
		return BasisTypenPackage.Literals.KENNZAHL_TYPE_CLASS;
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisTypenPackage.KENNZAHL_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BasisTypenPackage.KENNZAHL_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
