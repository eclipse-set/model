...
public class Signalbegriffe_StrukturSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Signalbegriffe_StrukturPackage.SIGNALBEGRIFF_ID_TYPE_CLASS: {
				Signalbegriff_ID_TypeClass signalbegriff_ID_TypeClass = (Signalbegriff_ID_TypeClass)theEObject;
				T result = caseSignalbegriff_ID_TypeClass(signalbegriff_ID_TypeClass);
