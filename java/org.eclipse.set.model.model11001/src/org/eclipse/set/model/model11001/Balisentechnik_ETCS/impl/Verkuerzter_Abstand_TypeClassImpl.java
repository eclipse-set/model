...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Verkuerzter Abstand Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Balisentechnik_ETCS.impl.Verkuerzter_Abstand_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Verkuerzter_Abstand_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Verkuerzter_Abstand_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Verkuerzter_Abstand_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Balisentechnik_ETCSPackage.eINSTANCE.getVerkuerzter_Abstand_TypeClass();
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Balisentechnik_ETCSPackage.VERKUERZTER_ABSTAND_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Balisentechnik_ETCSPackage.VERKUERZTER_ABSTAND_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Verkuerzter_Abstand_TypeClassImpl
