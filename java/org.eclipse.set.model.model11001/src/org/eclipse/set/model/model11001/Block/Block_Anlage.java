 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Block.Block_Anlage#getBlockAnlageAllg <em>Block Anlage Allg</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Block.Block_Anlage#getIDBlockElementA <em>ID Block Element A</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Block.Block_Anlage#getIDBlockElementB <em>ID Block Element B</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Block.Block_Anlage#getIDGleisBezeichnung <em>ID Gleis Bezeichnung</em>}</li>
 * </ul>
 *
 * @see org.eclipse.set.model.model11001.Block.BlockPackage#getBlock_Anlage()
...
public interface Block_Anlage extends Basis_Objekt {
	 ...
	 * @see org.eclipse.set.model.model11001.Block.BlockPackage#getBlock_Anlage_BlockAnlageAllg()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.model11001.Block.Block_Anlage#getBlockAnlageAllg <em>Block Anlage Allg</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.model11001.Block.BlockPackage#getBlock_Anlage_IDBlockElementA()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.model11001.Block.Block_Anlage#getIDBlockElementA <em>ID Block Element A</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.model11001.Block.BlockPackage#getBlock_Anlage_IDBlockElementB()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.model11001.Block.Block_Anlage#getIDBlockElementB <em>ID Block Element B</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.model11001.Block.BlockPackage#getBlock_Anlage_IDGleisBezeichnung()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.model11001.Block.Block_Anlage#getIDGleisBezeichnung <em>ID Gleis Bezeichnung</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
