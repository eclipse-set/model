...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstand Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Basisobjekte.impl.Abstand_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Abstand_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Abstand_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Abstand_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return BasisobjektePackage.Literals.ABSTAND_TYPE_CLASS;
	}
	...
	public void setWert(BigDecimal newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisobjektePackage.ABSTAND_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BasisobjektePackage.ABSTAND_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
