...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>DWeg Vorzug Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Fahrstrasse.impl.DWeg_Vorzug_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DWeg_Vorzug_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements DWeg_Vorzug_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected DWeg_Vorzug_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FahrstrassePackage.Literals.DWEG_VORZUG_TYPE_CLASS;
	}
	...
	public void setWert(Boolean newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FahrstrassePackage.DWEG_VORZUG_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FahrstrassePackage.DWEG_VORZUG_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
