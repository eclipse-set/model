...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstand ATO Halt Vor Eo AType Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.ATO.impl.Abstand_ATO_Halt_Vor_EoA_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Abstand_ATO_Halt_Vor_EoA_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Abstand_ATO_Halt_Vor_EoA_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Abstand_ATO_Halt_Vor_EoA_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ATOPackage.Literals.ABSTAND_ATO_HALT_VOR_EO_ATYPE_CLASS;
	}
	...
	public void setWert(BigDecimal newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ATOPackage.ABSTAND_ATO_HALT_VOR_EO_ATYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ATOPackage.ABSTAND_ATO_HALT_VOR_EO_ATYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Abstand_ATO_Halt_Vor_EoA_TypeClassImpl
