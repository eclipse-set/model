 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Zugnummernmeldeanlage.impl.ZN_Anzeigefeld_Allg_AttributeGroupImpl#getBedienbarkeitAnzeigefeld <em>Bedienbarkeit Anzeigefeld</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Zugnummernmeldeanlage.impl.ZN_Anzeigefeld_Allg_AttributeGroupImpl#getBfNrANB <em>Bf Nr ANB</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Zugnummernmeldeanlage.impl.ZN_Anzeigefeld_Allg_AttributeGroupImpl#getBfNrZNA <em>Bf Nr ZNA</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Zugnummernmeldeanlage.impl.ZN_Anzeigefeld_Allg_AttributeGroupImpl#getFunktionalitaetAnzeigefeld <em>Funktionalitaet Anzeigefeld</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Zugnummernmeldeanlage.impl.ZN_Anzeigefeld_Allg_AttributeGroupImpl#getHOA <em>HOA</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Zugnummernmeldeanlage.impl.ZN_Anzeigefeld_Allg_AttributeGroupImpl#getSichtbarkeitAnzeigefeld <em>Sichtbarkeit Anzeigefeld</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Zugnummernmeldeanlage.impl.ZN_Anzeigefeld_Allg_AttributeGroupImpl#getVerzoegerungManuellLoeschung <em>Verzoegerung Manuell Loeschung</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Zugnummernmeldeanlage.impl.ZN_Anzeigefeld_Allg_AttributeGroupImpl#getVormeldestart <em>Vormeldestart</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Zugnummernmeldeanlage.impl.ZN_Anzeigefeld_Allg_AttributeGroupImpl#getZNAnzeigefeldLoeschkriterium <em>ZN Anzeigefeld Loeschkriterium</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Zugnummernmeldeanlage.impl.ZN_Anzeigefeld_Allg_AttributeGroupImpl#getZNFeldOhneAnzeige <em>ZN Feld Ohne Anzeige</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Zugnummernmeldeanlage.impl.ZN_Anzeigefeld_Allg_AttributeGroupImpl#getZugvorbereitungsmeldung <em>Zugvorbereitungsmeldung</em>}</li>
 * </ul>
 *
 * @generated
 */
