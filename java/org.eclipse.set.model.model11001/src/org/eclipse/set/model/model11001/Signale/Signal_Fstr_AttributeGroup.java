 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Signale.Signal_Fstr_AttributeGroup#getBesetzteAusfahrt <em>Besetzte Ausfahrt</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Signale.Signal_Fstr_AttributeGroup#getDAManuell <em>DA Manuell</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Signale.Signal_Fstr_AttributeGroup#getDurchfahrt <em>Durchfahrt</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Signale.Signal_Fstr_AttributeGroup#getIDRaZielErlaubnisabhaengig <em>ID Ra Ziel Erlaubnisabhaengig</em>}</li>
 *   <li>{@link org.eclipse.set.model.model11001.Signale.Signal_Fstr_AttributeGroup#getRangierstrasseRestaufloesung <em>Rangierstrasse Restaufloesung</em>}</li>
 * </ul>
 *
 * @see org.eclipse.set.model.model11001.Signale.SignalePackage#getSignal_Fstr_AttributeGroup()
...
public interface Signal_Fstr_AttributeGroup extends EObject {
	 ...
	 * @see org.eclipse.set.model.model11001.Signale.SignalePackage#getSignal_Fstr_AttributeGroup_BesetzteAusfahrt()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.model11001.Signale.Signal_Fstr_AttributeGroup#getBesetzteAusfahrt <em>Besetzte Ausfahrt</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.model11001.Signale.SignalePackage#getSignal_Fstr_AttributeGroup_DAManuell()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.model11001.Signale.Signal_Fstr_AttributeGroup#getDAManuell <em>DA Manuell</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.set.model.model11001.Signale.SignalePackage#getSignal_Fstr_AttributeGroup_Durchfahrt()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.model11001.Signale.Signal_Fstr_AttributeGroup#getDurchfahrt <em>Durchfahrt</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>ID Ra Ziel Erlaubnisabhaengig</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @return the value of the '<em>ID Ra Ziel Erlaubnisabhaengig</em>' containment reference.
	 * @see #setIDRaZielErlaubnisabhaengig(ID_Block_Element_TypeClass)
	 * @see org.eclipse.set.model.model11001.Signale.SignalePackage#getSignal_Fstr_AttributeGroup_IDRaZielErlaubnisabhaengig()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.model11001.Signale.Signal_Fstr_AttributeGroup#getIDRaZielErlaubnisabhaengig <em>ID Ra Ziel Erlaubnisabhaengig</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>ID Ra Ziel Erlaubnisabhaengig</em>' containment reference.
	 * @see #getIDRaZielErlaubnisabhaengig()
	 * @generated
	 */
	void setIDRaZielErlaubnisabhaengig(ID_Block_Element_TypeClass value);
	 ...
	 * @see org.eclipse.set.model.model11001.Signale.SignalePackage#getSignal_Fstr_AttributeGroup_RangierstrasseRestaufloesung()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.set.model.model11001.Signale.Signal_Fstr_AttributeGroup#getRangierstrasseRestaufloesung <em>Rangierstrasse Restaufloesung</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
