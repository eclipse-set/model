...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Telefonnummer Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.PlanPro.impl.Telefonnummer_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Telefonnummer_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Telefonnummer_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Telefonnummer_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PlanProPackage.eINSTANCE.getTelefonnummer_TypeClass();
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlanProPackage.TELEFONNUMMER_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PlanProPackage.TELEFONNUMMER_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
