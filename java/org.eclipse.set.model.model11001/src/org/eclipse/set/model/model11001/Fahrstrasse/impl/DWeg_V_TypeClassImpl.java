...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>DWeg VType Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Fahrstrasse.impl.DWeg_V_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DWeg_V_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements DWeg_V_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected DWeg_V_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FahrstrassePackage.Literals.DWEG_VTYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FahrstrassePackage.DWEG_VTYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FahrstrassePackage.DWEG_VTYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
