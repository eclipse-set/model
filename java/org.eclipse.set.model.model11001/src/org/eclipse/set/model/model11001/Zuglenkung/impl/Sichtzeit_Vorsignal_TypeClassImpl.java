...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sichtzeit Vorsignal Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Zuglenkung.impl.Sichtzeit_Vorsignal_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Sichtzeit_Vorsignal_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Sichtzeit_Vorsignal_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Sichtzeit_Vorsignal_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ZuglenkungPackage.Literals.SICHTZEIT_VORSIGNAL_TYPE_CLASS;
	}
	...
	public void setWert(BigDecimal newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZuglenkungPackage.SICHTZEIT_VORSIGNAL_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ZuglenkungPackage.SICHTZEIT_VORSIGNAL_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Sichtzeit_Vorsignal_TypeClassImpl
