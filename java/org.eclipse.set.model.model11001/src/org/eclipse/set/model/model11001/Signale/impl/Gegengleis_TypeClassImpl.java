...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Gegengleis Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Signale.impl.Gegengleis_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Gegengleis_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Gegengleis_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Gegengleis_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SignalePackage.Literals.GEGENGLEIS_TYPE_CLASS;
	}
	...
	public void setWert(Boolean newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SignalePackage.GEGENGLEIS_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SignalePackage.GEGENGLEIS_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
