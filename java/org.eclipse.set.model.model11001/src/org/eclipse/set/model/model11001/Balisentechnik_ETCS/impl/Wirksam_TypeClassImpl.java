...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Wirksam Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Balisentechnik_ETCS.impl.Wirksam_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Wirksam_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Wirksam_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Wirksam_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Balisentechnik_ETCSPackage.eINSTANCE.getWirksam_TypeClass();
	}
	...
	public void setWert(Boolean newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Balisentechnik_ETCSPackage.WIRKSAM_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Balisentechnik_ETCSPackage.WIRKSAM_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
