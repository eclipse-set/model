...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Hauptschloss Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Schluesselabhaengigkeiten.impl.Hauptschloss_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Hauptschloss_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Hauptschloss_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Hauptschloss_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SchluesselabhaengigkeitenPackage.Literals.HAUPTSCHLOSS_TYPE_CLASS;
	}
	...
	public void setWert(Boolean newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchluesselabhaengigkeitenPackage.HAUPTSCHLOSS_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SchluesselabhaengigkeitenPackage.HAUPTSCHLOSS_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
