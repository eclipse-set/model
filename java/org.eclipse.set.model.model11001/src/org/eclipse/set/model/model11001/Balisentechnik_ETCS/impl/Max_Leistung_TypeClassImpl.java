...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Max Leistung Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Balisentechnik_ETCS.impl.Max_Leistung_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Max_Leistung_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Max_Leistung_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Max_Leistung_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Balisentechnik_ETCSPackage.eINSTANCE.getMax_Leistung_TypeClass();
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Balisentechnik_ETCSPackage.MAX_LEISTUNG_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Balisentechnik_ETCSPackage.MAX_LEISTUNG_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
