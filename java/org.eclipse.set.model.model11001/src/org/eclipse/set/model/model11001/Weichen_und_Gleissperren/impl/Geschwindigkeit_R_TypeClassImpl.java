...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Geschwindigkeit RType Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Weichen_und_Gleissperren.impl.Geschwindigkeit_R_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Geschwindigkeit_R_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Geschwindigkeit_R_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Geschwindigkeit_R_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Weichen_und_GleissperrenPackage.Literals.GESCHWINDIGKEIT_RTYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Weichen_und_GleissperrenPackage.GESCHWINDIGKEIT_RTYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Weichen_und_GleissperrenPackage.GESCHWINDIGKEIT_RTYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Geschwindigkeit_R_TypeClassImpl
