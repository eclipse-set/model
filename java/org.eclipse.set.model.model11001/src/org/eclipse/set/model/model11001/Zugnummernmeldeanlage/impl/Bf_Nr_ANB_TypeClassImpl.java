...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bf Nr ANB Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Zugnummernmeldeanlage.impl.Bf_Nr_ANB_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Bf_Nr_ANB_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Bf_Nr_ANB_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Bf_Nr_ANB_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ZugnummernmeldeanlagePackage.Literals.BF_NR_ANB_TYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZugnummernmeldeanlagePackage.BF_NR_ANB_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ZugnummernmeldeanlagePackage.BF_NR_ANB_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
