...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pruefgeschwindigkeit Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.PZB.impl.Pruefgeschwindigkeit_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pruefgeschwindigkeit_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Pruefgeschwindigkeit_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Pruefgeschwindigkeit_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PZBPackage.Literals.PRUEFGESCHWINDIGKEIT_TYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PZBPackage.PRUEFGESCHWINDIGKEIT_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PZBPackage.PRUEFGESCHWINDIGKEIT_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Pruefgeschwindigkeit_TypeClassImpl
