...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bezeichnung Anlage Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.PlanPro.impl.Bezeichnung_Anlage_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Bezeichnung_Anlage_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Bezeichnung_Anlage_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Bezeichnung_Anlage_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PlanProPackage.eINSTANCE.getBezeichnung_Anlage_TypeClass();
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlanProPackage.BEZEICHNUNG_ANLAGE_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PlanProPackage.BEZEICHNUNG_ANLAGE_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Bezeichnung_Anlage_TypeClassImpl
