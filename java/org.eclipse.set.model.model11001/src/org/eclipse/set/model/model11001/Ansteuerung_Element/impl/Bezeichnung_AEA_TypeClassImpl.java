...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bezeichnung AEA Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Ansteuerung_Element.impl.Bezeichnung_AEA_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Bezeichnung_AEA_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Bezeichnung_AEA_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Bezeichnung_AEA_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Ansteuerung_ElementPackage.Literals.BEZEICHNUNG_AEA_TYPE_CLASS;
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ansteuerung_ElementPackage.BEZEICHNUNG_AEA_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ansteuerung_ElementPackage.BEZEICHNUNG_AEA_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
