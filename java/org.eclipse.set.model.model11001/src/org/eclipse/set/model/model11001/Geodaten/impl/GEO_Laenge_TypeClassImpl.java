...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GEO Laenge Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Geodaten.impl.GEO_Laenge_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GEO_Laenge_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements GEO_Laenge_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected GEO_Laenge_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GeodatenPackage.Literals.GEO_LAENGE_TYPE_CLASS;
	}
	...
	public void setWert(BigDecimal newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeodatenPackage.GEO_LAENGE_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GeodatenPackage.GEO_LAENGE_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
