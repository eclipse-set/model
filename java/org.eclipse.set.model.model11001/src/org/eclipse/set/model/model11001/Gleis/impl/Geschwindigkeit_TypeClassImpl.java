 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Gleis.impl.Geschwindigkeit_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Geschwindigkeit_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Geschwindigkeit_TypeClass {
	...
	protected EClass eStaticClass() {
		return GleisPackage.Literals.GESCHWINDIGKEIT_TYPE_CLASS;
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GleisPackage.GESCHWINDIGKEIT_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GleisPackage.GESCHWINDIGKEIT_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
