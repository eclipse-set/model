...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>LEU Schaltkasten Typ Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Balisentechnik_ETCS.impl.LEU_Schaltkasten_Typ_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LEU_Schaltkasten_Typ_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements LEU_Schaltkasten_Typ_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected LEU_Schaltkasten_Typ_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Balisentechnik_ETCSPackage.eINSTANCE.getLEU_Schaltkasten_Typ_TypeClass();
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Balisentechnik_ETCSPackage.LEU_SCHALTKASTEN_TYP_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Balisentechnik_ETCSPackage.LEU_SCHALTKASTEN_TYP_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //LEU_Schaltkasten_Typ_TypeClassImpl
