...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EMail Adresse Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.PlanPro.impl.E_Mail_Adresse_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class E_Mail_Adresse_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements E_Mail_Adresse_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected E_Mail_Adresse_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PlanProPackage.eINSTANCE.getE_Mail_Adresse_TypeClass();
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlanProPackage.EMAIL_ADRESSE_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PlanProPackage.EMAIL_ADRESSE_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
