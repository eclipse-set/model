...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Informativ Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.PlanPro.impl.Informativ_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Informativ_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Informativ_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Informativ_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PlanProPackage.eINSTANCE.getInformativ_TypeClass();
	}
	...
	public void setWert(Boolean newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlanProPackage.INFORMATIV_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PlanProPackage.INFORMATIV_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
