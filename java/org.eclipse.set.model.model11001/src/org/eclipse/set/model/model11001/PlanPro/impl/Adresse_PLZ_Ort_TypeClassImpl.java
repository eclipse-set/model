...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Adresse PLZ Ort Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.PlanPro.impl.Adresse_PLZ_Ort_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Adresse_PLZ_Ort_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Adresse_PLZ_Ort_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Adresse_PLZ_Ort_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PlanProPackage.eINSTANCE.getAdresse_PLZ_Ort_TypeClass();
	}
	...
	public void setWert(String newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlanProPackage.ADRESSE_PLZ_ORT_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PlanProPackage.ADRESSE_PLZ_ORT_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
