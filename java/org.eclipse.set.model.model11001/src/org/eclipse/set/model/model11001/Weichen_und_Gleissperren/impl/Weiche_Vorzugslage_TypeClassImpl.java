...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Weiche Vorzugslage Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Weichen_und_Gleissperren.impl.Weiche_Vorzugslage_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Weiche_Vorzugslage_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements Weiche_Vorzugslage_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected Weiche_Vorzugslage_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Weichen_und_GleissperrenPackage.Literals.WEICHE_VORZUGSLAGE_TYPE_CLASS;
	}
	...
	public void setWert(ENUMLinksRechts newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Weichen_und_GleissperrenPackage.WEICHE_VORZUGSLAGE_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Weichen_und_GleissperrenPackage.WEICHE_VORZUGSLAGE_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
...
} //Weiche_Vorzugslage_TypeClassImpl
