...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>VBC Kennung Type Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.model11001.Balisentechnik_ETCS.impl.VBC_Kennung_TypeClassImpl#getWert <em>Wert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VBC_Kennung_TypeClassImpl extends BasisAttribut_AttributeGroupImpl implements VBC_Kennung_TypeClass {
	/**
	 ...
	 * @generated
	 */
	protected VBC_Kennung_TypeClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Balisentechnik_ETCSPackage.eINSTANCE.getVBC_Kennung_TypeClass();
	}
	...
	public void setWert(BigInteger newWert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Balisentechnik_ETCSPackage.VBC_KENNUNG_TYPE_CLASS__WERT, oldWert, wert, !oldWertESet));
	}
	...
	public void unsetWert() {
		...
		wertESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Balisentechnik_ETCSPackage.VBC_KENNUNG_TYPE_CLASS__WERT, oldWert, WERT_EDEFAULT, oldWertESet));
	}
